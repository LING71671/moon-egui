...
- **Headless & Automated Testing**: Core logic produces pure `DrawCmd` streams without browser bindings, backed by 380 automated headless unit and integration tests (100% passing).
