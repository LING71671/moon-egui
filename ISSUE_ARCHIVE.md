# Technical Archive: Resolved Defects & Delivered Capabilities

<p>
  <a href="ISSUE_ARCHIVE.md">English</a> · <a href="ISSUE_ARCHIVE_zh.md">简体中文</a>
</p>

> This document archives all 90+ historically resolved defects, architectural refactorings, and delivered milestones for `moon-egui`.
> For active defects, open roadmap initiatives, and the prioritized issue backlog, please refer to **[ISSUE.md](ISSUE.md)** ([中文版](ISSUE_zh.md)).
