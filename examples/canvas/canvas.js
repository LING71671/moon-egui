...
const _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS1290 = 1099511628211n;
const _M0MP49LING7167111moon_2degui3src4core2Id9with__intN5primeS1269 = 1099511628211n;
const _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS4592 = "\n";
const _M0FP49LING7167111moon_2degui3src4core9hex__byteN11hex__digitsS428 = "0123456789ABCDEF";
const _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229 = new _M0TP49LING7167111moon_2degui3src4core2Id(0n);
const _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS5237 = new _M0TP49LING7167111moon_2degui3src4core9Modifiers(false, false, false, false);
...
const _M0MP49LING7167111moon_2degui3src4core13WindowManager3newN6constrS5228 = 32;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5230 = 128;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5231 = 128;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5232 = 128;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5233 = 64;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5234 = 32;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5235 = 256;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5236 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS5240 = 256;
...
const _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS5242 = true;
const _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1060 = "gallery_win";
const _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS5243 = { _0: "...", _1: -1 };
...
const _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einnerN6constrS5241 = 0;
...
function _M0IP49LING7167111moon_2degui3src4core15LayoutDirectionPB2Eq5equal(_x_2951, _x_2952) {
  switch (_x_2951) {
    case 0: {
      if (_x_2952 === 0) {
        return true;
...
function _M0IP49LING7167111moon_2degui3src4core12TextSpanKindPB2Eq5equal(_x_2899, _x_2900) {
  switch (_x_2899.$tag) {
    case 0: {
      if (_x_2900.$tag === 0) {
        return true;
    ...
    default: {
      const _Link = _x_2899;
      const _$42$x0_2901 = _Link._0;
      if (_x_2900.$tag === 3) {
        const _Link$2 = _x_2900;
        const _$42$y0_2902 = _Link$2._0;
        return _$42$x0_2901 === _$42$y0_2902;
      } else {
        return false;
      }
    }
...
function _M0IP49LING7167111moon_2degui3src4core3KeyPB2Eq5equal(_x_2855, _x_2856) {
  switch (_x_2855) {
    case 0: {
      if (_x_2856 === 0) {
        return true;
...
function _M0MP49LING7167111moon_2degui3src4core2Id10with__seed(seed, str) {
  ...
  while (true) {
    ...
    if (i < str.length) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ char_code) * _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS1290);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext6window(self, title, pos, size, content, id_salt, constrain_to) {
  ...
  if (is_active && self.input.mouse_released) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext15set__active__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229);
  }
  if (window_hovered) {
...
function _M0MP49LING7167111moon_2degui3src4core2Id9with__int(seed, index) {
  ...
  while (true) {
    ...
    if (_ < 8) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ byte_val) * _M0MP49LING7167111moon_2degui3src4core2Id9with__intN5primeS1269);
...
function _M0MP49LING7167111moon_2degui3src4core12FocusManager14request__focus(self, id) {
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, id)) {
    if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229)) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15allocate__space(self, size) {
  ...
  if (self.input.mouse_released && is_active) {
    _M0MP49LING7167111moon_2degui3src4core12FocusManager15set__active__id(self.focus, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229);
  }
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext8checkbox(self, text, checked) {
  ...
  if (checked) {
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), box_rect, _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), radius);
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), box_rect, stroke_color, stroke_w, radius);
    const inner = _M0MP49LING7167111moon_2degui3src4math4Rect6shrink(box_rect, 4 * scale);
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), inner, _M0MP49LING7167111moon_2degui3src5color5Color13text__inverse(), 2 * scale);
  } else {
    ...
    const stroke_w = _resp.has_focus ? 1.5 * scale : 1;
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), box_rect, box_bg, radius);
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), box_rect, box_border, stroke_w, radius);
  }
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(text_x, text_y), text, font_nm, text_color, "", 500);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext5radio(self, label, selected) {
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter11add__circle(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), center, circle_r, bg_circle_color);
  _M0MP49LING7167111moon_2degui3src4core7Painter19add__circle__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), center, circle_r, outer_color, 1.5 * scale);
  if (selected) {
    _M0MP49LING7167111moon_2degui3src4core7Painter11add__circle(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), center, circle_r * 0.5, _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary());
  }
  ...
  const text_color = _resp.hovered ? _M0MP49LING7167111moon_2degui3src5color5Color13text__primary() : _M0MP49LING7167111moon_2degui3src5color5Color10text__body();
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), text_pos, label, font_nm, text_color, "", 500);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext6toggle(self, text, checked) {
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), switch_rect, bg_color, switch_h * 0.5);
  if (_resp.has_focus) {
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), switch_rect, _M0MP49LING7167111moon_2degui3src5color5Color13border__focus(), 1.5 * scale, switch_h * 0.5);
  }
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), thumb_rect, _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), thumb_radius);
    ...
    if (c < total_cols) {
      ...
      if (_M0MP49LING7167111moon_2degui3src4math4Rect8contains(col_header_rect, self.input.mouse_pos)) {
        ...
        if (!handle_hovered) {
          ...
          if (BigInt.asUintN(64, _p$2.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229.val)) {
            _tmp$3 = true;
          } else {
    ...
    if (r < end_row) {
      ...
      if (is_row_hovered) {
        ...
        if (self.input.mouse_pressed) {
          let _tmp$4;
          const _p = _M0MP49LING7167111moon_2degui3src4core9UIContext10active__id(self);
          if (BigInt.asUintN(64, _p.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229.val)) {
            _tmp$4 = true;
          } else {
            const _p$2 = _M0MP49LING7167111moon_2degui3src4core9UIContext10active__id(self);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext6slider(self, label, value, min, max) {
  ...
  if (label.length > 0) {
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(_rect.x, _rect.y + (h - 13) * 0.5), label, 13, _M0MP49LING7167111moon_2degui3src5color5Color13text__primary(), "", 500);
  }
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), track_rect, _M0MP49LING7167111moon_2degui3src5color5Color11bg__surface(), 3);
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), track_rect, _M0MP49LING7167111moon_2degui3src5color5Color13border__muted(), 1, 3);
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MP49LING7167111moon_2degui3src4core7Painter11add__circle(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(tick_x, tick_y), 1.5, tick_col);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (active_w > 0) {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), fill_rect, _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), 3);
  }
  let val_text;
  if (safe_range >= 10) {
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter11add__circle(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(thumb_cx, thumb_cy), thumb_r, _M0MP49LING7167111moon_2degui3src5color5Color10bg__window());
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter19add__circle__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(thumb_cx, thumb_cy), thumb_r, thumb_stroke, thumb_stroke_w);
  if (is_active) {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), bubble_rect, _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), radius_sm);
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), bubble_rect, _M0MP49LING7167111moon_2degui3src5color5Color15border__default(), 1, radius_sm);
    const bubble_text_pos = _M0MP49LING7167111moon_2degui3src4math4Vec23new(bubble_x + 7 * scale$2, bubble_y + (bubble_h - font_sm) * 0.5);
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), bubble_text_pos, val_text, font_sm, _M0MP49LING7167111moon_2degui3src5color5Color13text__primary(), "", 500);
  }
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(track_rect.x + track_w + 10, _rect.y + (h - 12) * 0.5), val_text, 12, _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary(), "", 500);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1821(_env, pt) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einner(self, id_salt, series, size, show_grid, show_crosshair, show_legend) {
  ...
  const _env = { _0: min_y, _1: min_x, _2: span_y, _3: plot_bottom, _4: span_x, _5: plot_rect };
  if (show_grid) {
    let _tmp$2 = 0;
    while (true) {
      const i = _tmp$2;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        switch (_bind$4) {
          case 0: {
            let prev_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1821(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$3 = 1;
            while (true) {
              const i = _tmp$3;
              if (i < count) {
                const curr_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1821(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          case 1: {
            ...
            while (true) {
              const i = _tmp$4;
              if (i < count) {
                const pt_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1821(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          default: {
            let prev_screen$2 = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1821(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$5 = 1;
            while (true) {
              const i = _tmp$5;
              if (i < count) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext4menu(self, title, content) {
  ...
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229) && (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, menu_id) && hovered)) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
  } else {
    if (hovered && self.input.mouse_pressed) {
      if (is_open) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229);
      } else {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
      }
    }
...
function _M0MP49LING7167111moon_2degui3src4core6Memory3new() {
  const _bind = [];
  const _tmp = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5230);
  const _bind$2 = [];
  const _tmp$2 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IddE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IddEE(_bind$2, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5231);
  const _bind$3 = [];
  const _tmp$3 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdbE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdbEE(_bind$3, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5232);
  const _bind$4 = [];
  const _tmp$4 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdsE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdsEE(_bind$4, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5233);
  const _bind$5 = [];
  const _tmp$5 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdRP49LING7167111moon_2degui3src4core2IdE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdRP49LING7167111moon_2degui3src4core2IdEE(_bind$5, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5234);
  const _bind$6 = [];
  const _tmp$6 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind$6, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5235);
  const _bind$7 = [];
  return new _M0TP49LING7167111moon_2degui3src4core6Memory(_tmp, _tmp$2, _tmp$3, _tmp$4, _tmp$5, _tmp$6, _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdRPB5ArrayGRP49LING7167111moon_2degui3src4core2IdEE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdRPB5ArrayGRP49LING7167111moon_2degui3src4core2IdEEE(_bind$7, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5236));
}
...
function _M0MP49LING7167111moon_2degui3src4core10InputState3new() {
  return new _M0TP49LING7167111moon_2degui3src4core10InputState(_M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, false, false, false, false, false, false, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, 0.0166, [], [], [], [], "", _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS5237, []);
}
...
function _M0MP49LING7167111moon_2degui3src4core12FocusManager3new() {
  return new _M0TP49LING7167111moon_2degui3src4core12FocusManager(_M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, [], false, false);
}
function _M0MP49LING7167111moon_2degui3src4core12FocusManager12begin__frame(self) {
  ...
  self.pending_lost_focus_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext13fader_2einner(self, id_salt, label, value, min_val, max_val, step, default_val, unit, show_ticks, size) {
  ...
  if (label.length > 0) {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(lbl_x, _rect.y), label, font_nm, _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary(), "", 500);
  }
  if (show_ticks) {
    ...
    while (true) {
      ...
      if (i <= 5) {
        ...
        _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(center_x - track_w * 0.5 - 2 * scale - cur_len, ty), _M0MP49LING7167111moon_2degui3src4math4Vec23new(center_x - track_w * 0.5 - 2 * scale, ty), tick_col, 1);
        _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(center_x + track_w * 0.5 + 2 * scale, ty), _M0MP49LING7167111moon_2degui3src4math4Vec23new(center_x + track_w * 0.5 + 2 * scale + cur_len, ty), tick_col, 1);
        _tmp = i + 1 | 0;
        continue;
      } else {
        break;
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), track_rect, _M0MP49LING7167111moon_2degui3src5color5Color16fader__track__bg(), track_w * 0.5);
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), track_rect, _M0MP49LING7167111moon_2degui3src5color5Color13border__muted(), 1, track_w * 0.5);
  ...
  if (clamped_frac > 0.001) {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), fill_rect, _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), track_w * 0.5);
  }
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Rect3new(cap_rect.x, cap_rect.y + 1 * scale, cap_rect.w, cap_rect.h), _M0MP49LING7167111moon_2degui3src5color5Color21pill__ambient__shadow(), cap_radius);
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), cap_rect, cap_bg, cap_radius);
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), cap_rect, cap_border, 1, cap_radius);
  const line_w = cap_w - 8 * scale;
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(center_x - line_w * 0.5, cap_y), _M0MP49LING7167111moon_2degui3src4math4Vec23new(center_x + line_w * 0.5, cap_y), is_active || is_focused ? _M0MP49LING7167111moon_2degui3src5color5Color16fader__cap__line() : _M0MP49LING7167111moon_2degui3src5color5Color14border__strong(), 1.5 * scale);
  if (is_focused) {
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Rect6expand(cap_rect, 2 * scale), _M0MP49LING7167111moon_2degui3src5color5Color13border__focus(), 1.5, cap_radius + 2 * scale);
  }
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(readout_x, readout_y), readout_str, font_sm, is_active || is_focused ? _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary() : _M0MP49LING7167111moon_2degui3src5color5Color11text__muted(), "monospace", 500);
...
function _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__message(ctx, message, max_w, font_size) {
  const lines = [];
  const raw_paragraphs = _M0MPC16string6String5split(message, new _M0TPC16string10StringView(_M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS4592, 0, _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS4592.length));
  while (true) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext3new() {
  ...
  const _bind = [];
  return new _M0TP49LING7167111moon_2degui3src4core9UIContext(_tmp, _tmp$2, _tmp$3, _tmp$4, layers, _tmp$5, _tmp$6, _tmp$7, _tmp$8, "default", 0, 0, 0, _M0MPC17hashmap7HashMap7HashMapGsdE(new _M0TPB9ArrayViewGUsdEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS5240), _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229, "");
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext10combo__box(self, id_salt, label, selected_index, options) {
  ...
  if (_tmp) {
    if (is_open) {
      _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229);
    } else {
...
function _M0FP49LING7167111moon_2degui3src4core9hex__byte(val) {
  const hi = val >> 4 & 15;
  const lo = val & 15;
  const hi_s = _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(_M0FP49LING7167111moon_2degui3src4core9hex__byteN11hex__digitsS428, hi, hi + 1 | 0));
  const lo_s = _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(_M0FP49LING7167111moon_2degui3src4core9hex__byteN11hex__digitsS428, lo, lo + 1 | 0));
  return `${hi_s}${lo_s}`;
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einner(self, id_salt, text, size, show_line_numbers, read_only) {
  ...
  if (is_focused) {
    ...
    if (ctrl_held && _M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(self.input, 14)) {
      ...
      selection_anchor = _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einnerN6constrS5241;
      cursor_pos = current_text.length;
    }
  ...
  if (is_focused && (_M0MP49LING7167111moon_2degui3src4core9UIContext18is__caret__visible(self) && _active_line < lines.length)) {
    ...
    if (caret_y + self.style.caret_h * scale >= _rect.y && caret_y <= _rect.y + _rect.h) {
      _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(self), _M0MP49LING7167111moon_2degui3src4math4Vec23new(caret_x, caret_y), _M0MP49LING7167111moon_2degui3src4math4Vec23new(caret_x, caret_y + self.style.caret_h * scale), _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), 1.5 * scale);
    }
  }
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext14button_2einner(self, text, shortcut, primary, size) {
  ...
  if (has_shortcut) {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(text_x, text_y), text, font_size, text_color, "", 500);
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, kbd_rect, kbd_bg, self.style.radius_sm * scale);
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(kbd_text_x, kbd_text_y), shortcut, kbd_font_size, kbd_col, "", 500);
  } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primary(self, text) {
  return _M0MP49LING7167111moon_2degui3src4core9UIContext6button(self, text, undefined, _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS5242, undefined);
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einner(self, id_salt, items, separator, max_visible) {
  ...
  if (should_fold) {
    ...
    _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(display_items, _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS5243);
...
function _M0FP49LING7167111moon_2degui8examples6canvas21gallery__step_2einner(comp_id, mouse_x, mouse_y, mouse_down, scroll_dy, vp_w, vp_h, text_input, keys_pressed, keys_released, mod_flags, mouse_secondary_down) {
  ...
  if (!(comp_id === _p)) {
    ...
    _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229);
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5229);
  }
