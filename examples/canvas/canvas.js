...
const _M0MP49LING7167111moon_2degui3src9composite10TableStyle7defaultN6recordS3018 = new _M0TP49LING7167111moon_2degui3src9composite10TableStyle(32, 30, 6);
const _M0MP49LING7167111moon_2degui3src9composite9PlotStyle7defaultN6recordS3019 = new _M0TP49LING7167111moon_2degui3src9composite9PlotStyle(280, 150, 38, 14, 14, 24, 280, 150, 8);
const _M0MP49LING7167111moon_2degui3src9composite10FaderStyle7defaultN6recordS3021 = new _M0TP49LING7167111moon_2degui3src9composite10FaderStyle(44, 150, 6, 32, 20, 3);
const _M0MP49LING7167111moon_2degui3src9composite15CodeEditorStyle7defaultN6recordS3022 = new _M0TP49LING7167111moon_2degui3src9composite15CodeEditorStyle(12.5, 11, 20, 44, 6);
...
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1080 = 2;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1081 = 3;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1082 = 5;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1083 = 8;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1084 = 9;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1085 = 6;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1086 = 7;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1087 = 12;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1088 = 13;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1089 = 10;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1090 = 11;
...
const _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einnerN6constrS3023 = 0;
...
function _M0IP49LING7167111moon_2degui3src9composite12TextSpanKindPB2Eq5equal(_x_1646, _x_1647) {
  switch (_x_1646.$tag) {
    case 0: {
      if (_x_1647.$tag === 0) {
        return true;
    ...
    default: {
      const _Link = _x_1646;
      const _$42$x0_1648 = _Link._0;
      if (_x_1647.$tag === 3) {
        const _Link$2 = _x_1647;
        const _$42$y0_1649 = _Link$2._0;
        return _$42$x0_1648 === _$42$y0_1649;
      } else {
        return false;
      }
    }
...
function _M0FP49LING7167111moon_2degui3src9composite13table_2einner(ctx, id_salt, size, columns, row_count, render_cell, row_height, header_height, selected_row, sort_column, sort_direction) {
  const scale = ctx.style.scale;
  const t_style = _M0MP49LING7167111moon_2degui3src9composite10TableStyle7defaultN6recordS3018;
...
function _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1185(_env, pt) {
  const min_x = _env._5;
...
function _M0FP49LING7167111moon_2degui3src9composite12plot_2einner(ctx, id_salt, series, size, show_grid, show_crosshair, show_legend) {
  const scale = ctx.style.scale;
  const p_style = _M0MP49LING7167111moon_2degui3src9composite9PlotStyle7defaultN6recordS3019;
  ...
  const _env = { _0: plot_bottom, _1: min_y, _2: span_y, _3: span_x, _4: plot_rect, _5: min_x };
  if (show_grid) {
    let _tmp$2 = 0;
    while (true) {
      const i = _tmp$2;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        switch (_bind$4) {
          case 0: {
            let prev_screen = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1185(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$3 = 1;
            while (true) {
              const i = _tmp$3;
              if (i < count) {
                const curr_screen = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1185(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          case 1: {
            ...
            while (true) {
              const i = _tmp$4;
              if (i < count) {
                const pt_screen = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1185(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          default: {
            let prev_screen$2 = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1185(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$5 = 1;
            while (true) {
              const i = _tmp$5;
              if (i < count) {
...
function _M0MP49LING7167111moon_2degui3src9composite5Fader4show(self, ctx) {
  ...
  const font_nm = ctx.style.font_normal * scale;
  const font_sm = ctx.style.font_small * scale;
  const f_style = _M0MP49LING7167111moon_2degui3src9composite10FaderStyle7defaultN6recordS3021;
  ...
  switch (node.$tag) {
    ...
    case 0: {
      ...
      while (true) {
        const i = _tmp;
        if (i < _tabs.length) {
          const tab = _M0MPC15array5Array2atGsE(_tabs, i);
          const font_sz = ctx.style.font_small * scale;
          ...
          if (is_hovered) {
            if (ctx.input.mouse_released) {
              ...
              if (_bind === undefined) {
                if (i !== valid_active) {
                  tab_switched = { _0: _M0MPC15array5Array2atGsE(_tabs, valid_active).id, _1: tab.id };
                  new_active_idx = i;
                }
              }
            }
      ...
      if (content_rect.w > 0 && content_rect.h > 0) {
        ...
        const active_tab_id = _M0MPC15array5Array2atGsE(_tabs, valid_active).id;
...
function _M0FP49LING7167111moon_2degui3src9composite28context__menu__items_2einner(ctx, id_salt, open, pos, items, menu_width, viewport_size) {
  ...
  if (actionable.length > 0) {
    ...
    const kb_item = _M0MPC15array5Array2atGsE(items, cur);
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 2)) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 2);
...
function _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einner(ctx, id_salt, text, size, show_line_numbers, read_only) {
  ...
  const scale = ctx.style.scale;
  const ce_style = _M0MP49LING7167111moon_2degui3src9composite15CodeEditorStyle7defaultN6recordS3022;
  ...
  if (is_focused) {
    ...
    if (ctrl_held && _M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 14)) {
      ...
      selection_anchor = _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einnerN6constrS3023;
...
function _M0FP49LING7167111moon_2degui3src7widgets18breadcrumb_2einner(ctx, id_salt, items, separator, max_visible) {
  ...
  if (is_focused && selectable.length > 0) {
    ...
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 2)) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 2);
      clicked_idx = _M0MPC15array5Array2atGsE(display_items, _M0MPC15array5Array2atGiE(selectable, cur))._1;
    }
  }
...
function _M0FP49LING7167111moon_2degui8examples6canvas9host__key(name) {
  switch (name) {
    case "Tab": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1079;
    }
    case "Enter": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1080;
    }
    case "Escape": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1081;
    }
    case " ": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1082;
    }
    case "ArrowUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1083;
    }
    case "ArrowDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1084;
    }
    case "ArrowLeft": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1085;
    }
    case "ArrowRight": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1086;
    }
    case "PageUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1087;
    }
    case "PageDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1088;
    }
    case "Home": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1089;
    }
    case "End": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1090;
    }
    case "Backspace": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1091;
    }
    case "Delete": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1092;
    }
    default: {
      return undefined;
    }
...
function _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcase(ui, vp_w, vp_h) {
  ...
  }, _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1098, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h));
}
