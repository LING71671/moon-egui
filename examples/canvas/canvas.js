...
const _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS887 = 1099511628211n;
const _M0MP49LING7167111moon_2degui3src4core9UIContext18rich__text_2einnerN7_2abindS2938 = " ";
const _M0FP49LING7167111moon_2degui3src4core9hex__byteN11hex__digitsS343 = "0123456789ABCDEF";
const _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580 = new _M0TP49LING7167111moon_2degui3src4core2Id(0n);
const _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS3581 = new _M0TP49LING7167111moon_2degui3src4core9Modifiers(false, false, false, false);
const _M0MP49LING7167111moon_2degui3src4core15ContextMenuItem9separatorN6recordS3582 = new _M0TP49LING7167111moon_2degui3src4core15ContextMenuItem("", "", "", true, true);
...
const _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS3583 = true;
const _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS977 = "gallery_win";
const _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS3584 = { _0: "...", _1: -1 };
...
function _M0IP49LING7167111moon_2degui3src4core15LayoutDirectionPB2Eq5equal(_x_1976, _x_1977) {
  if (_x_1976 === 0) {
    if (_x_1977 === 0) {
      return true;
    } else {
...
function _M0IP49LING7167111moon_2degui3src4core12TextSpanKindPB2Eq5equal(_x_1924, _x_1925) {
  switch (_x_1924.$tag) {
    case 0: {
      if (_x_1925.$tag === 0) {
        return true;
...
function _M0IP49LING7167111moon_2degui3src4core3KeyPB2Eq5equal(_x_1892, _x_1893) {
  switch (_x_1892) {
    case 0: {
      if (_x_1893 === 0) {
        return true;
...
function _M0MP49LING7167111moon_2degui3src4core2Id10with__seed(seed, str) {
  ...
  while (true) {
    ...
    if (i < str.length) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ char_code) * _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS887);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext6window(self, title, pos, size, content, id_salt, constrain_to) {
  ...
  if (is_active && self.input.mouse_released) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext15set__active__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580);
  }
  if (window_hovered) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext14request__focus(self, id) {
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, id)) {
    if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580)) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15allocate__space(self, size) {
  ...
  if (self.input.mouse_released && is_active) {
    self.active_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580;
  }
...
function _M0MP49LING7167111moon_2degui3src4core11WidgetStyle7default() {
  return new _M0TP49LING7167111moon_2degui3src4core11WidgetStyle(1, 32, 14, 6, 68, 32, 10, 5, 16, 24, 120, 4, 7, 36, 20, 8, 20, 20, 44, 13, 11, 15, _M0MP49LING7167111moon_2degui3src4math4Vec23new(8, 8), 4, 6, 10, 12, 34, 3, 7, 5, 12, 380, 160, 12, 80);
}
    ...
    if (c < total_cols) {
      ...
      if (_M0MP49LING7167111moon_2degui3src4math4Rect8contains(col_header_rect, self.input.mouse_pos)) {
        ...
        if (!handle_hovered) {
          let _tmp$3;
          const _p$2 = self.active_id;
          if (BigInt.asUintN(64, _p$2.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580.val)) {
            _tmp$3 = true;
          } else {
    ...
    if (r < end_row) {
      ...
      if (is_row_hovered) {
        ...
        if (self.input.mouse_pressed) {
          let _tmp$4;
          const _p = self.active_id;
          if (BigInt.asUintN(64, _p.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580.val)) {
            _tmp$4 = true;
          } else {
            const _p$2 = self.active_id;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext18rich__text_2einner(self, id_salt, spans, wrap_width) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const span = spans[_];
      const words = _M0MPC16string6String5split(span.text, new _M0TPC16string10StringView(_M0MP49LING7167111moon_2degui3src4core9UIContext18rich__text_2einnerN7_2abindS2938, 0, _M0MP49LING7167111moon_2degui3src4core9UIContext18rich__text_2einnerN7_2abindS2938.length));
      while (true) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext4menu(self, title, content) {
  ...
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580) && (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, menu_id) && hovered)) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
  } else {
    if (hovered && self.input.mouse_pressed) {
      if (is_open) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580);
      } else {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
      }
    }
...
function _M0MP49LING7167111moon_2degui3src4core10InputState3new() {
  return new _M0TP49LING7167111moon_2degui3src4core10InputState(_M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, false, false, false, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, 0.0166, [], [], [], "", _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS3581, []);
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext3new() {
  return new _M0TP49LING7167111moon_2degui3src4core9UIContext(_M0MP49LING7167111moon_2degui3src4core10InputState3new(), _M0MP49LING7167111moon_2degui3src4draw8DrawList3new(), _M0MP49LING7167111moon_2degui3src4core7IdStack3new(), _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, [], _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, 800, _M0MP49LING7167111moon_2degui3src4math4Vec23new(8, 8), [], 0, [new _M0TP49LING7167111moon_2degui3src4core11LayoutScope(0, 0, 0, 0)], [], [], [], [], [], [], -1, [], [], [], [], _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580, false, false, _M0MP49LING7167111moon_2degui3src4draw8DrawList3new(), _M0MP49LING7167111moon_2degui3src4draw8DrawList3new(), [], false, [], [], _M0MP49LING7167111moon_2degui3src4core11WidgetStyle7default(), "default", 0, 0);
}
function _M0MP49LING7167111moon_2degui3src4core9UIContext12begin__frame(self, raw_input) {
  ...
  self.hot_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580;
  self.prev_focused_id = self.focused_id;
  self.lost_focus_id = self.pending_lost_focus_id;
  self.pending_lost_focus_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext10combo__box(self, id_salt, label, selected_index, options) {
  ...
  if (_tmp) {
    if (is_open) {
      _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580);
    } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext29color__picker__button_2einner(self, id_salt, color, show_alpha) {
  ...
  if (_resp.clicked) {
    if (is_open) {
      self.open_combo_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580;
    } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primary(self, text) {
  return _M0MP49LING7167111moon_2degui3src4core9UIContext6button(self, text, undefined, _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS3583, undefined);
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einner(self, id_salt, items, separator, max_visible) {
  ...
  if (should_fold) {
    ...
    _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(display_items, _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS3584);
...
function _M0FP49LING7167111moon_2degui8examples6canvas13gallery__step(comp_id, mouse_x, mouse_y, mouse_down, scroll_dy, vp_w, vp_h, text_input, keys_pressed, keys_released, mod_flags) {
  ...
  if (!(comp_id === _p)) {
    ...
    _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580);
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS3580);
  }
