...
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1268 = 4;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1269 = 2;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1270 = 3;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1271 = 5;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1272 = 8;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1273 = 9;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1274 = 6;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1275 = 7;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1276 = 12;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1277 = 13;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1278 = 10;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1279 = 11;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1280 = 0;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1281 = 1;
...
const _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3newN6constrS1267 = 64;
...
function _M0FP49LING7167111moon_2degui8examples6canvas19mines__number__font(cell) {
  const f = cell * 0.58;
  return f < 9 ? 9 : f > 15 ? 15 : f;
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3new(seed) {
  const _bind = [];
  return new _M0TP49LING7167111moon_2degui8examples6canvas9MineWorld(seed, _M0MPB3Map3MapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(new _M0TPB9ArrayViewGUmRP49LING7167111moon_2degui8examples6canvas9MineChunkEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3newN6constrS1267), [], 0, 0, 0, 0, undefined);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas17mines__draw__flag(painter, sx, sy, cell) {
  const raw_mast = cell * 0.075;
  const mast_w = raw_mast < 1.2 ? 1.2 : raw_mast > 3 ? 3 : raw_mast;
  const left = sx + cell * 0.25;
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(left, sy + cell * 0.14, mast_w, cell * 0.72), _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary(), mast_w * 0.5);
  const bar = cell * 0.42 / (4 + 0);
  let _tmp = 0;
  while (true) {
    const k = _tmp;
    if (k < 4) {
      const t = (k + 0) / (4 + 0);
      _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(left + mast_w, sy + cell * (0.15 + 0.42 * t), cell * (0.46 - 0.32 * t), bar), _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), 0);
      _tmp = k + 1 | 0;
      continue;
    } else {
      return;
...
function _M0FP49LING7167111moon_2degui8examples6canvas11mines__step(mouse_x, mouse_y, mouse_down, mouse_secondary_down, pan_dx, pan_dy, zoom_delta, action_switch, vp_w, vp_h) {
  ...
  if (zoom_delta !== 0) {
    ...
    const new_cell = old_cell * factor > 56 ? 56 : old_cell * factor < 12 ? 12 : old_cell * factor;
  ...
  const num_font = _M0FP49LING7167111moon_2degui8examples6canvas19mines__number__font(cell);
  let _tmp = row0;
  while (true) {
    const r = _tmp;
    if (r < (row0 + rows | 0)) {
        ...
        if (c < (col0 + cols | 0)) {
          ...
          if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(world, c, r)) {
            ...
            if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8is__mine(world, c, r)) {
              ...
              if (adj > 0) {
                const label = _M0MPC13int3Int18to__string_2einner(adj, 10);
                const ty$2 = sy + (cell - num_font) * 0.5;
                const tx$2 = sx + (cell - _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(_M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx, label, num_font).x) * 0.5;
                _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(tx$2, ty$2), label, num_font, _M0FP49LING7167111moon_2degui8examples6canvas20mines__number__color(adj), "monospace", 500);
              }
            }
          } else {
            ...
            if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld11is__flagged(world, c, r)) {
              _M0FP49LING7167111moon_2degui8examples6canvas17mines__draw__flag(painter, sx, sy, cell);
            }
          }
          _tmp$2 = c + 1 | 0;
          continue;
...
function _M0FP49LING7167111moon_2degui8examples6canvas9host__key(name) {
  switch (name) {
    ...
    case "PageUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1276;
    }
    case "PageDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1277;
    }
    case "Home": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1278;
    }
    case "End": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1279;
    }
    case "Backspace": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1280;
    }
    case "Delete": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1281;
    }
    default: {
      return undefined;
    }
...
function _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcase(ui) {
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 14);
  _M0MP49LING7167111moon_2degui3src4core9UIContext10horizontal(ui, (row) => {
    _M0FP49LING7167111moon_2degui3src7widgets7spinner(row, _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1285, undefined, _M0DTPC16option6OptionGdE4None__);
    _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(row, 16);
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 16);
  _M0FP49LING7167111moon_2degui3src7widgets20spinner__with__label(ui, "正在同步远程 MoonBit 模块索引...", _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1286, undefined, _M0DTPC16option6OptionGdE4None__);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcase(ui, vp_w, vp_h) {
  ...
  }, _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1287, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h));
}
