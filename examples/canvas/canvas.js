...
const _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS1373 = 1099511628211n;
const _M0MP49LING7167111moon_2degui3src4core2Id9with__intN5primeS1352 = 1099511628211n;
const _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS5011 = "\n";
const _M0FP49LING7167111moon_2degui3src4core9hex__byteN11hex__digitsS448 = "0123456789ABCDEF";
const _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649 = new _M0TP49LING7167111moon_2degui3src4core2Id(0n);
const _M0MP49LING7167111moon_2degui3src4core10TableStyle7defaultN6recordS5650 = new _M0TP49LING7167111moon_2degui3src4core10TableStyle(32, 30, 6);
const _M0MP49LING7167111moon_2degui3src4core9PlotStyle7defaultN6recordS5651 = new _M0TP49LING7167111moon_2degui3src4core9PlotStyle(280, 150, 38, 14, 14, 24, 280, 150, 8);
const _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS5660 = new _M0TP49LING7167111moon_2degui3src4core9Modifiers(false, false, false, false);
const _M0MP49LING7167111moon_2degui3src4core10FaderStyle7defaultN6recordS5663 = new _M0TP49LING7167111moon_2degui3src4core10FaderStyle(44, 150, 6, 32, 20, 3);
const _M0MP49LING7167111moon_2degui3src4core15CodeEditorStyle7defaultN6recordS5665 = new _M0TP49LING7167111moon_2degui3src4core15CodeEditorStyle(12.5, 11, 20, 44, 6);
...
const _M0MP49LING7167111moon_2degui3src4core13WindowManager3newN6constrS5648 = 32;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5652 = 128;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5653 = 128;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5654 = 128;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5655 = 64;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5656 = 32;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5657 = 256;
const _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5658 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS5664 = 256;
...
const _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS5667 = true;
const _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1060 = "gallery_win";
const _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS5668 = { _0: "...", _1: -1 };
...
const _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einnerN6constrS5666 = 0;
...
function _M0IP49LING7167111moon_2degui3src4core15LayoutDirectionPB2Eq5equal(_x_3129, _x_3130) {
  switch (_x_3129) {
    case 0: {
      if (_x_3130 === 0) {
        return true;
...
function _M0IP49LING7167111moon_2degui3src4core12TextSpanKindPB2Eq5equal(_x_3095, _x_3096) {
  switch (_x_3095.$tag) {
    case 0: {
      if (_x_3096.$tag === 0) {
        return true;
    ...
    default: {
      const _Link = _x_3095;
      const _$42$x0_3097 = _Link._0;
      if (_x_3096.$tag === 3) {
        const _Link$2 = _x_3096;
        const _$42$y0_3098 = _Link$2._0;
        return _$42$x0_3097 === _$42$y0_3098;
      } else {
        return false;
      }
    }
...
function _M0IP49LING7167111moon_2degui3src4core3KeyPB2Eq5equal(_x_3075, _x_3076) {
  switch (_x_3075) {
    case 0: {
      if (_x_3076 === 0) {
        return true;
...
function _M0MP49LING7167111moon_2degui3src4core2Id10with__seed(seed, str) {
  ...
  while (true) {
    ...
    if (i < str.length) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ char_code) * _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS1373);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext6window(self, title, pos, size, content, id_salt, constrain_to) {
  ...
  if (is_active && self.input.mouse_released) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext15set__active__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649);
  }
  if (window_hovered) {
...
function _M0MP49LING7167111moon_2degui3src4core2Id9with__int(seed, index) {
  ...
  while (true) {
    ...
    if (_ < 8) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ byte_val) * _M0MP49LING7167111moon_2degui3src4core2Id9with__intN5primeS1352);
...
function _M0MP49LING7167111moon_2degui3src4core12FocusManager14request__focus(self, id) {
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, id)) {
    if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649)) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15allocate__space(self, size) {
  ...
  if (self.input.mouse_released && is_active) {
    _M0MP49LING7167111moon_2degui3src4core12FocusManager15set__active__id(self.focus, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649);
  }
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext13table_2einner(self, id_salt, size, columns, row_count, render_cell, row_height, header_height, selected_row, sort_column, sort_direction) {
  const scale = self.style.scale;
  const t_style = _M0MP49LING7167111moon_2degui3src4core10TableStyle7defaultN6recordS5650;
    ...
    if (c < total_cols) {
      ...
      if (_M0MP49LING7167111moon_2degui3src4math4Rect8contains(col_header_rect, self.input.mouse_pos)) {
        ...
        if (!handle_hovered) {
          ...
          if (BigInt.asUintN(64, _p$2.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649.val)) {
            _tmp$3 = true;
          } else {
    ...
    if (r < end_row) {
      ...
      if (is_row_hovered) {
        ...
        if (self.input.mouse_pressed) {
          let _tmp$4;
          const _p = _M0MP49LING7167111moon_2degui3src4core9UIContext10active__id(self);
          if (BigInt.asUintN(64, _p.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649.val)) {
            _tmp$4 = true;
          } else {
            const _p$2 = _M0MP49LING7167111moon_2degui3src4core9UIContext10active__id(self);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1979(_env, pt) {
  const plot_bottom = _env._5;
  const plot_rect = _env._4;
  const span_y = _env._3;
  const min_y = _env._2;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einner(self, id_salt, series, size, show_grid, show_crosshair, show_legend) {
  const scale = self.style.scale;
  const p_style = _M0MP49LING7167111moon_2degui3src4core9PlotStyle7defaultN6recordS5651;
  ...
  const _env = { _0: min_x, _1: span_x, _2: min_y, _3: span_y, _4: plot_rect, _5: plot_bottom };
  if (show_grid) {
    let _tmp$2 = 0;
    while (true) {
      const i = _tmp$2;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        switch (_bind$4) {
          case 0: {
            let prev_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1979(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$3 = 1;
            while (true) {
              const i = _tmp$3;
              if (i < count) {
                const curr_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1979(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          case 1: {
            ...
            while (true) {
              const i = _tmp$4;
              if (i < count) {
                const pt_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1979(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          default: {
            let prev_screen$2 = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1979(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$5 = 1;
            while (true) {
              const i = _tmp$5;
              if (i < count) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext4menu(self, title, content) {
  ...
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649) && (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, menu_id) && hovered)) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
  } else {
    if (hovered && self.input.mouse_pressed) {
      if (is_open) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649);
      } else {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
      }
    }
...
function _M0MP49LING7167111moon_2degui3src4core6Memory3new() {
  const _bind = [];
  const _tmp = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5652);
  const _bind$2 = [];
  const _tmp$2 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IddE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IddEE(_bind$2, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5653);
  const _bind$3 = [];
  const _tmp$3 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdbE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdbEE(_bind$3, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5654);
  const _bind$4 = [];
  const _tmp$4 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdsE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdsEE(_bind$4, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5655);
  const _bind$5 = [];
  const _tmp$5 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdRP49LING7167111moon_2degui3src4core2IdE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdRP49LING7167111moon_2degui3src4core2IdEE(_bind$5, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5656);
  const _bind$6 = [];
  const _tmp$6 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind$6, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5657);
  const _bind$7 = [];
  return new _M0TP49LING7167111moon_2degui3src4core6Memory(_tmp, _tmp$2, _tmp$3, _tmp$4, _tmp$5, _tmp$6, _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdRPB5ArrayGRP49LING7167111moon_2degui3src4core2IdEE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdRPB5ArrayGRP49LING7167111moon_2degui3src4core2IdEEE(_bind$7, 0, 0), _M0MP49LING7167111moon_2degui3src4core6Memory3newN6constrS5658));
}
...
function _M0MP49LING7167111moon_2degui3src4core10InputState3new() {
  return new _M0TP49LING7167111moon_2degui3src4core10InputState(_M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, false, false, false, false, false, false, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, 0.0166, [], [], [], [], "", _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS5660, []);
}
...
function _M0MP49LING7167111moon_2degui3src4core12FocusManager3new() {
  return new _M0TP49LING7167111moon_2degui3src4core12FocusManager(_M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, [], false, false);
}
function _M0MP49LING7167111moon_2degui3src4core12FocusManager12begin__frame(self) {
  ...
  self.pending_lost_focus_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649;
...
function _M0MP49LING7167111moon_2degui3src4core5Fader4show(self, ctx) {
  ...
  const f_style = _M0MP49LING7167111moon_2degui3src4core10FaderStyle7defaultN6recordS5663;
...
function _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__message(ctx, message, max_w, font_size) {
  const lines = [];
  const raw_paragraphs = _M0MPC16string6String5split(message, new _M0TPC16string10StringView(_M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS5011, 0, _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS5011.length));
  while (true) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext3new() {
  ...
  const _bind = [];
  return new _M0TP49LING7167111moon_2degui3src4core9UIContext(_tmp, _tmp$2, _tmp$3, _tmp$4, layers, _tmp$5, _tmp$6, _tmp$7, _tmp$8, "default", 0, 0, 0, _M0MPC17hashmap7HashMap7HashMapGsdE(new _M0TPB9ArrayViewGUsdEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS5664), _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649, "");
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext10combo__box(self, id_salt, label, selected_index, options) {
  ...
  if (_tmp) {
    if (is_open) {
      _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649);
    } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einner(self, id_salt, text, size, show_line_numbers, read_only) {
  ...
  const scale = self.style.scale;
  const ce_style = _M0MP49LING7167111moon_2degui3src4core15CodeEditorStyle7defaultN6recordS5665;
  ...
  if (is_focused) {
    ...
    if (ctrl_held && _M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(self.input, 14)) {
      ...
      selection_anchor = _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einnerN6constrS5666;
      cursor_pos = current_text.length;
    }
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primary(self, text) {
  return _M0MP49LING7167111moon_2degui3src4core9UIContext6button(self, text, undefined, _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS5667, undefined);
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einner(self, id_salt, items, separator, max_visible) {
  ...
  if (should_fold) {
    ...
    _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(display_items, _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS5668);
...
function _M0FP49LING7167111moon_2degui8examples6canvas21gallery__step_2einner(comp_id, mouse_x, mouse_y, mouse_down, scroll_dy, vp_w, vp_h, text_input, keys_pressed, keys_released, mod_flags, mouse_secondary_down) {
  ...
  if (!(comp_id === _p)) {
    ...
    _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649);
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS5649);
  }
