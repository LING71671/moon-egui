...
const _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS1185 = 1099511628211n;
const _M0MP49LING7167111moon_2degui3src4core2Id9with__intN5primeS1164 = 1099511628211n;
const _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS3880 = "\n";
const _M0FP49LING7167111moon_2degui3src4core9hex__byteN11hex__digitsS423 = "0123456789ABCDEF";
const _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553 = new _M0TP49LING7167111moon_2degui3src4core2Id(0n);
const _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS4554 = new _M0TP49LING7167111moon_2degui3src4core9Modifiers(false, false, false, false);
...
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1101 = 4;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1102 = 2;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1103 = 3;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1104 = 5;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1105 = 8;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1106 = 9;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1107 = 6;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1108 = 7;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1109 = 12;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1110 = 13;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1111 = 10;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1112 = 11;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1113 = 0;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1114 = 1;
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1121 = { _0: "Button 按钮", _1: "ui.button(text, shortcut~, primary~, size~) -> Response", _2: "///| Button 交互示例\npub fn draw_buttons(ui : @core.UIContext, state : AppState) -> Unit {\n  // 主要按钮（支持快捷键）\n  let res_primary = ui.button(\"提交操作\", shortcut=\"⌘S\", primary=true)\n  if res_primary.clicked {\n    state.count = state.count + 1\n  }\n\n  // 次要重置按钮\n  let res_reset = ui.button(\"重置状态\", shortcut=\"Esc\")\n  if res_reset.clicked {\n    state.count = 0\n  }\n\n  // 自定义尺寸按钮\n  let _ = ui.button(\"自定义尺寸\", size=Some(@math.Vec2::new(140.0, 36.0)))\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1122 = { _0: "TextEdit 文本输入", _1: "ui.text_edit(id_salt, text, placeholder~) -> (String, Response)", _2: "///| TextEdit 文本编辑示例\npub fn draw_text_edit(ui : @core.UIContext, state : AppState) -> Unit {\n  let (new_text, res) = ui.text_edit(\n    \"user_input\",\n    state.username,\n    placeholder=\"请输入用户名...\",\n  )\n  if res.changed {\n    state.username = new_text\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1123 = { _0: "CodeEditor 代码编辑器", _1: "ui.code_editor(id_salt, text, size~, show_line_numbers~, read_only~) -> (String, Response)", _2: "///| CodeEditor 代码编辑示例\npub fn draw_code_editor(ui : @core.UIContext, state : AppState) -> Unit {\n  let (updated_code, resp) = ui.code_editor(\n    \"cad_script\",\n    state.script_source,\n    size=Some(@math.Vec2::new(ui.available_width(), 240.0)),\n    show_line_numbers=true,\n    read_only=false,\n  )\n  if resp.changed() {\n    state.script_source = updated_code\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1124 = { _0: "RichText 流式富文本", _1: "ui.rich_text(spans, wrap_width~) -> Response", _2: "///| RichText 富文本示例\npub fn draw_rich_text(ui : @core.UIContext) -> Unit {\n  let spans = [\n    @core.TextSpan::bold(\"MoonBit Native GUI \"),\n    @core.TextSpan::normal(\"提供高性能立即模式排版与 \"),\n    @core.TextSpan::code(\"Wasm-GC\"),\n    @core.TextSpan::normal(\" 运行时支持。\"),\n  ]\n  let _ = ui.rich_text(spans, wrap_width=ui.available_width())\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1125 = { _0: "Checkbox 复选框", _1: "ui.checkbox(label, is_checked) -> (Bool, Response)", _2: "///| Checkbox 复选框示例\npub fn draw_checkbox(ui : @core.UIContext, state : AppState) -> Unit {\n  let (checked, res) = ui.checkbox(\"启用硬件加速渲染\", state.gpu_enabled)\n  if res.changed {\n    state.gpu_enabled = checked\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1126 = { _0: "Toggle 胶囊开关", _1: "ui.toggle(label, is_checked) -> (Bool, Response)", _2: "///| Toggle 开关示例\npub fn draw_toggles(ui : @core.UIContext, state : AppState) -> Unit {\n  let (snap, res) = ui.toggle(\"吸附到网格节点\", state.grid_snap)\n  if res.changed {\n    state.grid_snap = snap\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1127 = { _0: "Radio 单选按钮", _1: "ui.radio(label, is_selected) -> (Bool, Response)", _2: "///| Radio 单选框示例\npub fn draw_radio(ui : @core.UIContext, state : AppState) -> Unit {\n  let (r1, _) = ui.radio(\"性能优先 (60 FPS)\", state.quality == 0)\n  if r1 { state.quality = 0 }\n  let (r2, _) = ui.radio(\"均衡模式 (渲染优化)\", state.quality == 1)\n  if r2 { state.quality = 1 }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1128 = { _0: "SegmentedControl 分段单选", _1: "ui.segmented_control(id_salt, selected_index, options) -> (Int, Response)", _2: "///| SegmentedControl 分段单选示例\npub fn draw_segmented(ui : @core.UIContext, state : AppState) -> Unit {\n  let (sel, res) = ui.segmented_control(\n    \"view_mode\",\n    state.selected_view,\n    [\"设计视图\", \"拆分对比\", \"代码查看\"],\n  )\n  if res.changed {\n    state.selected_view = sel\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1129 = { _0: "Slider 滑动条", _1: "ui.slider(label, value, min, max, format~) -> (Double, Response)", _2: "///| Slider 滑动条示例\npub fn draw_slider(ui : @core.UIContext, state : AppState) -> Unit {\n  let (new_val, res) = ui.slider(\"缩放倍率\", state.zoom, 0.1, 5.0, format=\"%.2fx\")\n  if res.changed {\n    state.zoom = new_val\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1130 = { _0: "DragValue 数字微调", _1: "ui.drag_value(label, value, speed~, min~, max~) -> (Double, Response)", _2: "///| DragValue 拖拽微调示例\npub fn draw_drag_value(ui : @core.UIContext, state : AppState) -> Unit {\n  let (new_val, res) = ui.drag_value(\"画板 X 偏移\", state.offset_x, speed=1.0)\n  if res.changed {\n    state.offset_x = new_val\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1131 = { _0: "Knob 旋钮调节器", _1: "ui.knob(id_salt, label, value, min, max, unit~) -> (Double, Response)", _2: "///| Knob 旋转音频/滤镜控制器示例\npub fn draw_knob(ui : @core.UIContext, state : AppState) -> Unit {\n  let (cutoff, res) = ui.knob(\"cutoff_knob\", \"低通截止\", state.cutoff, 20.0, 20000.0, unit=\"Hz\")\n  if res.changed {\n    state.cutoff = cutoff\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1132 = { _0: "ComboBox 下拉选择框", _1: "ui.combo_box(id_salt, selected_index, options) -> (Int, Response)", _2: "///| ComboBox 下拉选择器示例\npub fn draw_combo_box(ui : @core.UIContext, state : AppState) -> Unit {\n  let (sel, res) = ui.combo_box(\n    \"export_fmt\",\n    state.selected_format,\n    [\"SVG 矢量图像\", \"PNG 光栅切图\", \"PDF 工程图纸\"],\n  )\n  if res.changed {\n    state.selected_format = sel\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1133 = { _0: "ColorButton 调色板按钮", _1: "ui.color_button(id_salt, color, size~) -> (@color.Color, Response)", _2: "///| ColorButton 颜色预设按钮示例\npub fn draw_color_button(ui : @core.UIContext, state : AppState) -> Unit {\n  let (c, res) = ui.color_button(\"theme_color\", state.accent)\n  if res.clicked {\n    state.show_palette = true\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1134 = { _0: "ColorPicker HSV 拾色器", _1: "ui.color_picker(id_salt, color) -> (@color.Color, Response)", _2: "///| ColorPicker HSV 连续拾色器示例\npub fn draw_color_picker(ui : @core.UIContext, state : AppState) -> Unit {\n  let (new_col, res) = ui.color_picker(\"active_color_picker\", state.color)\n  if res.changed {\n    state.color = new_col\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1135 = { _0: "ProgressBar 进度条", _1: "ui.progress_bar(progress, text~) -> Unit", _2: "///| ProgressBar 进度条示例\npub fn draw_progress_bar(ui : @core.UIContext, state : AppState) -> Unit {\n  ui.progress_bar(state.load_progress, text=\"加载资产资源 68%\")\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1136 = { _0: "Spinner 微加载动画", _1: "ui.spinner(radius~, color~) -> Unit", _2: "///| Spinner 加载动画示例\npub fn draw_spinner(ui : @core.UIContext) -> Unit {\n  ui.spinner(radius=12.0, color=@color.Color::accent_primary())\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1137 = { _0: "Badge / Tag 徽章标签", _1: "ui.badge(text, kind~) -> Unit", _2: "///| Badge 徽章标签示例\npub fn draw_badges(ui : @core.UIContext) -> Unit {\n  ui.badge(\"运行正常\", kind=@core.BadgeKind::Success)\n  ui.badge(\"需要关注\", kind=@core.BadgeKind::Warning)\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1138 = { _0: "Sparkline 迷你走势图", _1: "ui.sparkline(data, width, height, color~) -> Unit", _2: "///| Sparkline 走势图示例\npub fn draw_sparkline(ui : @core.UIContext, state : AppState) -> Unit {\n  ui.sparkline(state.fps_history, 240.0, 48.0, color=@color.Color::accent_primary())\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1139 = { _0: "CollapsingHeader 折叠树", _1: "ui.collapsing_header(id_salt, label, content, default_open~) -> Unit", _2: "///| CollapsingHeader 折叠树示例\npub fn draw_collapsing(ui : @core.UIContext) -> Unit {\n  ui.collapsing_header(\"geom_group\", \"几何图元属性\", fn(ui_sub) {\n    let _ = ui_sub.label(\"顶点数量: 16,384\")\n    let _ = ui_sub.label(\"面片索引: 32,768\")\n  }, default_open=true)\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1140 = { _0: "TreeView 资产层级树", _1: "ui.tree_view(id_salt, root_node, expanded_ids, selected_id) -> (String?, Response)", _2: "///| TreeView 树状资源管理示例\npub fn draw_tree(ui : @core.UIContext, state : AppState) -> Unit {\n  let (sel, res) = ui.tree_view(\n    \"project_tree\",\n    state.project_root,\n    state.expanded_nodes,\n    state.selected_file,\n  )\n  if res.changed {\n    state.selected_file = sel\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1141 = { _0: "Tooltip 悬浮提示", _1: "ui.tooltip(target_rect, text) -> Unit", _2: "///| Tooltip 提示浮层示例\npub fn draw_tooltip_button(ui : @core.UIContext) -> Unit {\n  let resp = ui.button(\"查看帮助文档\")\n  if resp.hovered() {\n    ui.tooltip(resp.rect, \"点击在侧边栏打开 MoonBit API 参考手册\")\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1142 = { _0: "Splitter 分割面板", _1: "ui.split_horizontal(id_salt, ratio, left, right) -> Double", _2: "///| Splitter 分割视图示例\npub fn draw_splitter(ui : @core.UIContext, state : AppState) -> Unit {\n  let new_ratio = ui.split_horizontal(\n    \"main_split\",\n    state.ratio,\n    fn(ui_left, w, h) { draw_viewport(ui_left, w, h) },\n    fn(ui_right, w, h) { draw_inspector(ui_right, w, h) },\n  )\n  state.ratio = new_ratio\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1143 = { _0: "Table 虚拟化数据表格", _1: "ui.table(id_salt, columns, row_count, row_height~, cell_renderer) -> Unit", _2: "///| Table 数据表格示例\npub fn draw_table(ui : @core.UIContext, state : AppState) -> Unit {\n  ui.table(\n    \"telemetry_table\",\n    state.columns,\n    state.rows.length(),\n    row_height=28.0,\n    fn(ui_cell, row_idx, col_idx, rect) {\n      draw_cell(ui_cell, row_idx, col_idx, rect)\n    },\n  )\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1144 = { _0: "TabBar 标签页导航", _1: "ui.tab_bar(id_salt, selected_index, tabs) -> (Int, Response)", _2: "///| TabBar 选项卡导航示例\npub fn draw_tab_bar(ui : @core.UIContext, state : AppState) -> Unit {\n  let (sel, res) = ui.tab_bar(\n    \"studio_tabs\",\n    state.current_tab,\n    [\"图纸层\", \"物理碰撞\", \"渲染管线\"],\n  )\n  if res.changed {\n    state.current_tab = sel\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1145 = { _0: "MenuBar 顶层菜单栏", _1: "ui.menu_bar(menus) -> Unit", _2: "///| MenuBar 顶层菜单示例\npub fn draw_menu_bar(ui : @core.UIContext) -> Unit {\n  ui.menu_bar([\n    { title: \"文件\", items: [{ id: \"open\", label: \"打开工程...\", shortcut: \"⌘O\" }] },\n    { title: \"编辑\", items: [{ id: \"undo\", label: \"撤销\", shortcut: \"⌘Z\" }] },\n  ])\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1146 = { _0: "ScrollArea 滚动区域", _1: "ui.scroll_area(id_salt, size, content) -> Unit", _2: "///| ScrollArea 滚动裁剪容器示例\npub fn draw_scroll_area(ui : @core.UIContext) -> Unit {\n  ui.scroll_area(\n    \"log_scroll\",\n    @math.Vec2::new(320.0, 200.0),\n    fn(ui_inner) { draw_long_list(ui_inner) },\n  )\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1147 = { _0: "Breadcrumb 面包屑导航", _1: "ui.breadcrumb(items) -> (String?, Response)", _2: "///| Breadcrumb 路径导航示例\npub fn draw_breadcrumb(ui : @core.UIContext) -> Unit {\n  let (clicked, _) = ui.breadcrumb([\n    { id: \"root\", label: \"工作区\" },\n    { id: \"canvas\", label: \"画板演示\" },\n    { id: \"active\", label: \"组件配置\" },\n  ])\n  if clicked is Some(target) { navigate_to(target) }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1148 = { _0: "Window 浮动窗口", _1: "ui.window(title, pos, size, content) -> Response", _2: "///| Window 可拖拽悬浮窗示例\npub fn draw_floating_window(ui : @core.UIContext, state : AppState) -> Unit {\n  let _ = ui.window(\n    \"调试控制台\",\n    state.win_pos,\n    @math.Vec2::new(260.0, 320.0),\n    fn(ui_win) { draw_debug_controls(ui_win) },\n  )\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1149 = { _0: "Dialog 模态对话框", _1: "ui.dialog(title, message, is_open, show_cancel~) -> DialogResult", _2: "///| Dialog 模态对话框示例\npub fn draw_dialog(ui : @core.UIContext, state : AppState) -> Unit {\n  let res = ui.dialog(\n    \"确认清空画板\",\n    \"该操作将清除当前所有未保存的几何图元，是否继续？\",\n    state.dialog_open,\n    show_cancel=true,\n  )\n  match res {\n    Confirmed => { clear_canvas(); state.dialog_open = false }\n    Cancelled => state.dialog_open = false\n    Dismissed => ()\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1150 = { _0: "CommandPalette 命令面板", _1: "ui.command_palette(id_salt, query, items, is_open) -> CommandPaletteResult", _2: "///| CommandPalette 快捷命令搜寻器示例\npub fn draw_palette(ui : @core.UIContext, state : AppState) -> Unit {\n  let res = ui.command_palette(\"global_commands\", state.query, state.command_list, state.open)\n  match res {\n    Execute(cmd) => execute(cmd)\n    Close => state.open = false\n    None => ()\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1151 = { _0: "ContextMenu 上下文菜单", _1: "ui.context_menu(is_open, pos, items) -> (String?, Response)", _2: "///| ContextMenu 右键级联菜单示例\npub fn draw_context_menu(ui : @core.UIContext, state : AppState) -> Unit {\n  let (selected, _) = ui.context_menu(state.open, state.pos, state.menu_items)\n  if selected is Some(act) {\n    handle_action(act)\n    state.open = false\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1152 = { _0: "Toast 全局通知", _1: "ui.toast_stack(toasts, screen_size) -> Unit", _2: "///| Toast 状态通知条示例\npub fn draw_toasts(ui : @core.UIContext, state : AppState) -> Unit {\n  ui.toast_stack(state.toasts, ui.screen_rect().size())\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1153 = { _0: "Plot 交互图表", _1: "ui.plot(id_salt, series, size~, show_legend~, show_grid~) -> (PlotPoint?, Response)", _2: "///| Plot 交互图表示例\npub fn draw_plot(ui : @core.UIContext) -> Unit {\n  let line_pts = [\n    @core.PlotPoint::new(0.0, 10.0),\n    @core.PlotPoint::new(20.0, 45.0),\n    @core.PlotPoint::new(40.0, 30.0),\n    @core.PlotPoint::new(60.0, 80.0),\n    @core.PlotPoint::new(80.0, 65.0),\n    @core.PlotPoint::new(100.0, 95.0),\n  ]\n  let s_line = @core.PlotSeries::line(\"Trend Line\", line_pts)\n  let (hover_pt, resp) = ui.plot(\"metrics_plot\", [s_line], size=@math.Vec2::new(320.0, 180.0))\n  if hover_pt is Some(pt) {\n    println(\"Hovered: X=\" + pt.x.to_string() + \", Y=\" + pt.y.to_string())\n  }\n}" };
const _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1154 = { _0: "BarChart 柱状统计图", _1: "ui.bar_chart(id_salt, labels, values, size~, bar_color~, gap~) -> (Int?, Response)", _2: "///| BarChart 柱状图示例\npub fn draw_bar_chart(ui : @core.UIContext) -> Unit {\n  let labels = [\"Q1\", \"Q2\", \"Q3\", \"Q4\"]\n  let values = [125.0, 240.0, 180.0, 310.0]\n  let (hover_idx, resp) = ui.bar_chart(\n    \"quarterly_revenue\",\n    labels,\n    values,\n    size=@math.Vec2::new(300.0, 160.0),\n  )\n  if hover_idx is Some(idx) {\n    println(\"Hovered Quarter: \" + labels[idx])\n  }\n}" };
const _M0FPB4seed = _M0FPB12random__seed();
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4557 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4558 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4559 = 32;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4560 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4561 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4562 = 128;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4563 = 64;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4564 = 256;
const _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4565 = 64;
...
const _M0FP49LING7167111moon_2degui8examples6canvas14gallery__stateN6constrS1100 = "main_mbt";
const _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state = new _M0TP49LING7167111moon_2degui8examples6canvas12GalleryState(0, true, false, false, true, true, false, true, false, 1, 1.25, 85, 120, 80, 1, 1200, 25, 0, 6, 0, 1, 0, 0.68, _M0FP49LING7167111moon_2degui8examples6canvas14gallery__stateN6constrS1100, ["src", "assets"], 0, "MoonBit Developer", "dev@moonbitlang.com", "///| Welcome to moon-egui native CodeEditor\npub fn render(ui : @core.UIContext) -> Unit {\n  ui.label(\"Pure MoonBit Wasm Engine!\")\n  ui.button(\"Live Immediate-Mode\")\n}", [], false, "", 0, false, _M0MP49LING7167111moon_2degui3src4math4Vec23new(180, 140), "Ready", "", 0.45, "id", 0, [_M0MP49LING7167111moon_2degui3src4core11TableColumn11new_2einner("id", "ID", 60, 50, true), _M0MP49LING7167111moon_2degui3src4core11TableColumn11new_2einner("name", "Name", 140, 80, true), _M0MP49LING7167111moon_2degui3src4core11TableColumn11new_2einner("role", "Role", 110, 70, true), _M0MP49LING7167111moon_2degui3src4core11TableColumn11new_2einner("score", "Score", 80, 60, true)], 1, false, "None", 0, true, true, true, [12, 28, 19, 35, 22, 48, 38, 55, 42, 68, 60, 85], _M0MP49LING7167111moon_2degui3src5color5Color3rgb(79, 70, 229), "None", "None", 0, 0.5, 0);
const _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS4567 = true;
const _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1120 = "gallery_win";
const _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS4568 = { _0: "...", _1: -1 };
const _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1115 = "⌘C";
const _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1116 = "⌘V";
const _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1117 = "F12";
const _M0MPC16string10StringView4findN6constrS9865 = 0;
const _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1118 = new _M0DTPC16option6OptionGdE4Some(18);
const _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1119 = new _M0DTPC16option6OptionGdE4Some(18);
const _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einnerN6constrS4566 = 0;
...
function _M0IP49LING7167111moon_2degui3src4core15LayoutDirectionPB2Eq5equal(_x_2566, _x_2567) {
  switch (_x_2566) {
    case 0: {
      if (_x_2567 === 0) {
        return true;
...
function _M0IP49LING7167111moon_2degui3src4core12TextSpanKindPB2Eq5equal(_x_2514, _x_2515) {
  switch (_x_2514.$tag) {
    case 0: {
      if (_x_2515.$tag === 0) {
        return true;
    ...
    default: {
      const _Link = _x_2514;
      const _$42$x0_2516 = _Link._0;
      if (_x_2515.$tag === 3) {
        const _Link$2 = _x_2515;
        const _$42$y0_2517 = _Link$2._0;
        return _$42$x0_2516 === _$42$y0_2517;
      } else {
        return false;
      }
    }
...
function _M0IP49LING7167111moon_2degui3src4core3KeyPB2Eq5equal(_x_2482, _x_2483) {
  switch (_x_2482) {
    case 0: {
      if (_x_2483 === 0) {
        return true;
...
function _M0IP49LING7167111moon_2degui3src4core2IdPB4Hash13hash__combine(_x_2466, _x_2467) {
  _M0IPC16uint646UInt64PB4Hash13hash__combine(_x_2466.val, _x_2467);
}
...
function _M0MP49LING7167111moon_2degui3src4core2Id10with__seed(seed, str) {
  ...
  while (true) {
    ...
    if (i < str.length) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ char_code) * _M0MP49LING7167111moon_2degui3src4core2Id10with__seedN5primeS1185);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext6window(self, title, pos, size, content, id_salt, constrain_to) {
  ...
  if (is_active && self.input.mouse_released) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext15set__active__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553);
  }
  if (window_hovered) {
...
function _M0MP49LING7167111moon_2degui3src4core2Id9with__int(seed, index) {
  ...
  while (true) {
    ...
    if (_ < 8) {
      ...
      hash = BigInt.asUintN(64, BigInt.asUintN(64, hash ^ byte_val) * _M0MP49LING7167111moon_2degui3src4core2Id9with__intN5primeS1164);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext14request__focus(self, id) {
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, id)) {
    if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.focused_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553)) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15allocate__space(self, size) {
  ...
  if (self.input.mouse_released && is_active) {
    self.active_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553;
  }
    ...
    if (c < total_cols) {
      ...
      if (_M0MP49LING7167111moon_2degui3src4math4Rect8contains(col_header_rect, self.input.mouse_pos)) {
        ...
        if (!handle_hovered) {
          let _tmp$3;
          const _p$2 = self.active_id;
          if (BigInt.asUintN(64, _p$2.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553.val)) {
            _tmp$3 = true;
          } else {
    ...
    if (r < end_row) {
      ...
      if (is_row_hovered) {
        ...
        if (self.input.mouse_pressed) {
          let _tmp$4;
          const _p = self.active_id;
          if (BigInt.asUintN(64, _p.val) === BigInt.asUintN(64, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553.val)) {
            _tmp$4 = true;
          } else {
            const _p$2 = self.active_id;
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext11drag__value(self, label, value, speed, min, max) {
  ...
  if (label.length > 0) {
    _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(_rect.x, _rect.y + (h - font_nm) * 0.5), label, font_nm, _M0MP49LING7167111moon_2degui3src5color5Color13text__primary());
  }
  ...
  _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(text_x, text_y), val_str, font_sm, is_active ? _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary() : _M0MP49LING7167111moon_2degui3src5color5Color13text__primary());
  return { _0: new_val, _1: _resp };
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1505(_env, pt) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einner(self, id_salt, series, size, show_grid, show_crosshair, show_legend) {
  ...
  const _env = { _0: plot_bottom, _1: span_x, _2: min_y, _3: span_y, _4: min_x, _5: plot_rect };
  if (show_grid) {
    let _tmp$2 = 0;
    while (true) {
      const i = _tmp$2;
      if (i <= 4) {
        ...
        const label_sz = _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(self, label, font_sz);
        _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(plot_rect.x - label_sz.x - 4 * scale, gy - font_sz * 0.45), label, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color11text__muted());
        _tmp$2 = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    while (true) {
      ...
      if (i <= 4) {
        ...
        const label = _M0FP49LING7167111moon_2degui3src4core18format__coord__val(tick_val);
        const label_sz = _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(self, label, font_sz);
        _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(gx - label_sz.x * 0.5, plot_bottom + 4 * scale), label, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color11text__muted());
        _tmp$3 = i + 1 | 0;
        continue;
      } else {
        break;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        switch (_bind$4) {
          case 0: {
            let prev_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1505(_env, _M0MPC15array5Array2atGRP49LING7167111moon_2degui3src4core2IdE(pts, 0));
            let _tmp$3 = 1;
            while (true) {
              const i = _tmp$3;
              if (i < count) {
                const curr_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1505(_env, _M0MPC15array5Array2atGRP49LING7167111moon_2degui3src4core2IdE(pts, i));
          ...
          case 1: {
            ...
            while (true) {
              const i = _tmp$4;
              if (i < count) {
                const pt_screen = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1505(_env, _M0MPC15array5Array2atGRP49LING7167111moon_2degui3src4core2IdE(pts, i));
          ...
          default: {
            let prev_screen$2 = _M0MP49LING7167111moon_2degui3src4core9UIContext12plot_2einnerN21map__data__to__screenS1505(_env, _M0MPC15array5Array2atGRP49LING7167111moon_2degui3src4core2IdE(pts, 0));
            let _tmp$5 = 1;
            while (true) {
              const i = _tmp$5;
              if (i < count) {
  ...
  if (show_legend && series.length > 0) {
    ...
    while (true) {
      ...
      if (i >= 0) {
        ...
        _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(leg_x + 12 * scale, plot_rect.y + 4 * scale), s.name, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color11text__muted());
        leg_x = leg_x - 8 * scale;
        _tmp$3 = i - 1 | 0;
        continue;
      } else {
  ...
  if (is_hovered && show_crosshair) {
    ...
    _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(tip_x + tip_pad_x, tip_y + tip_pad_y), text, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color13text__inverse());
  }
  ...
  while (true) {
    ...
    if (i < count) {
      ...
      if (i < labels.length) {
        ...
        _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(lx, ly), lbl, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary());
      }
      if (is_bar_hovered) {
        ...
        _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(badge_x + badge_pad_x, badge_y + badge_pad_y), val_str, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color13text__inverse());
      }
      _tmp$3 = i + 1 | 0;
      continue;
    } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext4menu(self, title, content) {
  ...
  if (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553) && (_M0IP016_24default__implPB2Eq10not__equalGRP49LING7167111moon_2degui3src4core2IdE(self.open_menu_id, menu_id) && hovered)) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
  } else {
    if (hovered && self.input.mouse_pressed) {
      if (is_open) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553);
      } else {
        _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(self, menu_id);
      }
    }
...
function _M0MP49LING7167111moon_2degui3src4core10InputState3new() {
  return new _M0TP49LING7167111moon_2degui3src4core10InputState(_M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, false, false, false, false, false, false, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, 0.0166, [], [], [], [], "", _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS4554, []);
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext7tooltip(self, text) {
  ...
  _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(tip_rect.x + pad_x, tip_rect.y + pad_y), text, font_size, _M0MP49LING7167111moon_2degui3src5color5Color13text__inverse());
  _M0MP49LING7167111moon_2degui3src4core9UIContext15end__foreground(self);
}
function _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__message(ctx, message, max_w, font_size) {
  const lines = [];
  const raw_paragraphs = _M0MPC16string6String5split(message, new _M0TPC16string10StringView(_M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS3880, 0, _M0FP49LING7167111moon_2degui3src4core21wrap__dialog__messageN7_2abindS3880.length));
  while (true) {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext3new() {
  ...
  const _bind = [];
  const _tmp$8 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IddE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IddEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4557);
  const _bind$2 = [];
  const _tmp$9 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IddE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IddEE(_bind$2, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4558);
  const _bind$3 = [];
  const _tmp$10 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdRP49LING7167111moon_2degui3src4math4Vec2E(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdRP49LING7167111moon_2degui3src4math4Vec2EE(_bind$3, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4559);
  const _tmp$11 = [];
  const _tmp$12 = [];
  const _tmp$13 = [];
  const _tmp$14 = [];
  const _tmp$15 = [];
  const _bind$4 = [];
  const _tmp$16 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind$4, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4560);
  const _bind$5 = [];
  const _tmp$17 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdbE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdbEE(_bind$5, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4561);
  const _bind$6 = [];
  const _tmp$18 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind$6, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4562);
  const _bind$7 = [];
  const _tmp$19 = _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IdiE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IdiEE(_bind$7, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4563);
  ...
  const _bind$8 = [];
  const _tmp$27 = _M0MPC17hashmap7HashMap7HashMapGsdE(new _M0TPB9ArrayViewGUsdEE(_bind$8, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4564);
  const _bind$9 = [];
  return new _M0TP49LING7167111moon_2degui3src4core9UIContext(_tmp, _tmp$2, _tmp$3, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _tmp$4, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, 800, _tmp$5, _tmp$6, 0, _tmp$7, _tmp$8, _tmp$9, _tmp$10, _tmp$11, _tmp$12, _tmp$13, -1, _tmp$14, _tmp$15, _tmp$16, _tmp$17, _tmp$18, 0, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553, "", _tmp$19, false, false, _tmp$20, _tmp$21, _tmp$22, false, _tmp$23, _tmp$24, _tmp$25, _tmp$26, "default", 0, 0, _tmp$27, _M0MPC17hashmap7HashMap7HashMapGRP49LING7167111moon_2degui3src4core2IddE(new _M0TPB9ArrayViewGURP49LING7167111moon_2degui3src4core2IddEE(_bind$9, 0, 0), _M0MP49LING7167111moon_2degui3src4core9UIContext3newN6constrS4565));
}
function _M0MP49LING7167111moon_2degui3src4core9UIContext12begin__frame(self, raw_input) {
  ...
  self.hot_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553;
  self.prev_focused_id = self.focused_id;
  self.lost_focus_id = self.pending_lost_focus_id;
  self.pending_lost_focus_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553;
  _M0MPC15array5Array5clearGRP49LING7167111moon_2degui3src4math4RectE(self.focusable_ids);
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext10combo__box(self, id_salt, label, selected_index, options) {
  ...
  if (_tmp) {
    if (is_open) {
      _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(self, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553);
    } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext29color__picker__button_2einner(self, id_salt, color, show_alpha) {
  ...
  _M0MP49LING7167111moon_2degui3src4draw8DrawList9add__text(self.draw_list, _M0MP49LING7167111moon_2degui3src4math4Vec23new(_rect.x + swatch_pad * 2 + swatch_size, text_y), hex_text, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color10text__body());
  const _p = self.open_combo_id;
  ...
  if (_resp.clicked || key_toggle) {
    if (is_open) {
      self.open_combo_id = _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553;
    } else {
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einner(self, id_salt, text, size, show_line_numbers, read_only) {
  ...
  if (is_focused) {
    ...
    if (ctrl_held && _M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(self.input, 14)) {
      ...
      selection_anchor = _M0MP49LING7167111moon_2degui3src4core9UIContext20code__editor_2einnerN6constrS4566;
      cursor_pos = current_text.length;
    }
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primary(self, text) {
  return _M0MP49LING7167111moon_2degui3src4core9UIContext6button(self, text, undefined, _M0MP49LING7167111moon_2degui3src4core9UIContext15button__primaryN6constrS4567, undefined);
}
...
function _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einner(self, id_salt, items, separator, max_visible) {
  ...
  if (should_fold) {
    ...
    _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(display_items, _M0MP49LING7167111moon_2degui3src4core9UIContext18breadcrumb_2einnerN5tupleS4568);
...
function _M0FP49LING7167111moon_2degui8examples6canvas9host__key(name) {
  switch (name) {
    case "Tab": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1101;
    }
    case "Enter": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1102;
    }
    case "Escape": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1103;
    }
    case " ": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1104;
    }
    case "ArrowUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1105;
    }
    case "ArrowDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1106;
    }
    case "ArrowLeft": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1107;
    }
    case "ArrowRight": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1108;
    }
    case "PageUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1109;
    }
    case "PageDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1110;
    }
    case "Home": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1111;
    }
    case "End": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1112;
    }
    case "Backspace": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1113;
    }
    case "Delete": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1114;
    }
    default: {
      return undefined;
    }
...
function _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcase(ui, vp_w, vp_h) {
  ...
  const items = [_M0MP49LING7167111moon_2degui3src4core15ContextMenuItem3new("copy", "复制当前组件代码", _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1115, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src4core15ContextMenuItemEE4None__), _M0MP49LING7167111moon_2degui3src4core15ContextMenuItem3new("paste", "粘贴图元属性", _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1116, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src4core15ContextMenuItemEE4None__), _M0MP49LING7167111moon_2degui3src4core15ContextMenuItem9separator(), _M0MP49LING7167111moon_2degui3src4core15ContextMenuItem3new("inspect", "审查图元层级", _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1117, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src4core15ContextMenuItemEE4None__), _M0MP49LING7167111moon_2degui3src4core15ContextMenuItem3new("delete", "重置控件状态", undefined, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src4core15ContextMenuItemEE4None__)];
...
function _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcase(ui) {
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 14);
  _M0MP49LING7167111moon_2degui3src4core9UIContext10horizontal(ui, (row) => {
    _M0MP49LING7167111moon_2degui3src4core9UIContext7spinner(row, _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1118, undefined, _M0DTPC16option6OptionGdE4None__);
    _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(row, 16);
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 16);
  _M0MP49LING7167111moon_2degui3src4core9UIContext20spinner__with__label(ui, "正在同步远程 MoonBit 模块索引...", _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1119, undefined, _M0DTPC16option6OptionGdE4None__);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcase(ui, vp_w, vp_h) {
  ...
  }, _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1120, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h));
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__info(comp_id) {
  switch (comp_id) {
    case "button": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1121;
    }
    case "text_edit": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1122;
    }
    case "code_editor": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1123;
    }
    case "rich_text": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1124;
    }
    case "checkbox": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1125;
    }
    case "toggle": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1126;
    }
    case "radio": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1127;
    }
    case "segmented_control": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1128;
    }
    case "slider": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1129;
    }
    case "drag_value": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1130;
    }
    case "knob": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1131;
    }
    case "combo_box": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1132;
    }
    case "color_button": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1133;
    }
    case "color_picker": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1134;
    }
    case "progress_bar": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1135;
    }
    case "spinner": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1136;
    }
    case "badge": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1137;
    }
    case "sparkline": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1138;
    }
    case "collapsing_header": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1139;
    }
    case "tree_view": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1140;
    }
    case "tooltip": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1141;
    }
    case "splitter": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1142;
    }
    case "table": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1143;
    }
    case "tab_bar": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1144;
    }
    case "menu_bar": {
      return _M0FP49LING7167111moon_2degui8examples6canvas29get__gallery__component__infoN5tupleS1145;
    }
    case "scroll_area": {
...
function _M0FP49LING7167111moon_2degui8examples6canvas21gallery__step_2einner(comp_id, mouse_x, mouse_y, mouse_down, scroll_dy, vp_w, vp_h, text_input, keys_pressed, keys_released, mod_flags, mouse_secondary_down) {
  ...
  if (!(comp_id === _p)) {
    ...
    _M0MP49LING7167111moon_2degui3src4core9UIContext20set__open__combo__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553);
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__open__menu__id(_M0FP49LING7167111moon_2degui8examples6canvas12gallery__ctx, _M0MP49LING7167111moon_2degui3src4core2Id4zeroN6recordS4553);
  }
