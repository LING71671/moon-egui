...
function _M0TP49LING7167111moon_2degui3src9composite9PlotStyle(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
  ...
  this.pad_right = param3;
  this.pad_top = param4;
  this.pad_bottom = param5;
  this.bar_chart_default_w = param6;
...
function _M0TPB5EntryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(param0, param1, param2, param3, param4, param5) {
  this.prev = param0;
  this.next = param1;
  this.psl = param2;
  this.hash = param3;
...
function _M0TP49LING7167111moon_2degui3src4core11WidgetStyle(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20, param21, param22) {
  ...
  this.control_h_sm = param2;
  this.control_h_md = param3;
  this.control_h_lg = param4;
  this.font_xs = param5;
  this.font_sm = param6;
  this.font_small = param7;
  this.font_normal = param8;
  this.font_large = param9;
  this.font_xl = param10;
  this.spacing_xs = param11;
  this.spacing_sm = param12;
  this.spacing_md = param13;
  this.spacing_lg = param14;
  this.spacing_xl = param15;
  this.item_spacing = param16;
  this.radius_xs = param17;
  this.radius_sm = param18;
  this.radius_md = param19;
  this.radius_lg = param20;
  this.radius_xl = param21;
  this.caret_blink_interval = param22;
}
...
function _M0TP49LING7167111moon_2degui3src4core9UIContext(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16) {
  ...
  this.style = param7;
  this.theme = param8;
  this.cursor_icon = param9;
  this.time = param10;
  this.frame_counter = param11;
  this.last_caret_activity = param12;
  this.text_measure_cache = param13;
  this.open_combo_id = param14;
  this.open_menu_id = param15;
  this.active_submenu_id = param16;
}
...
function _M0TP49LING7167111moon_2degui8examples6canvas9MineWorld(param0, param1, param2, param3, param4, param5, param6, param7) {
  this.seed = param0;
  this.threshold = param1;
  this.chunks = param2;
  this.queue = param3;
  this.queue_head = param4;
  this.revealed_count = param5;
  this.flagged_count = param6;
  this.status = param7;
}
function _M0TPB9ArrayViewGUmRP49LING7167111moon_2degui8examples6canvas9MineChunkEE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
function _M0TP49LING7167111moon_2degui8examples6canvas9MineChunk(param0, param1) {
  this.revealed = param0;
  this.flagged = param1;
}
function _M0TP49LING7167111moon_2degui8examples6canvas10MinesFrame(param0, param1, param2, param3, param4, param5, param6, param7) {
  this.draw_list = param0;
...
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1262 = 4;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1263 = 2;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1264 = 3;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1265 = 5;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1266 = 8;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1267 = 9;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1268 = 6;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1269 = 7;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1270 = 12;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1271 = 13;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1272 = 10;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1273 = 11;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1274 = 0;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1275 = 1;
...
function _M0FPB8new__mapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(capacity) {
  const capacity$2 = _M0MPC13int3Int20next__power__of__two(capacity);
  const _bind = capacity$2 - 1 | 0;
  const _bind$2 = (Math.imul(capacity$2, 13) | 0) / 16 | 0;
  const _bind$3 = $make_array_len_and_init(capacity$2, undefined);
  const _bind$4 = undefined;
  return new _M0TPB3MapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(_bind$3, 0, capacity$2, _bind, _bind$2, _bind$4, -1);
}
...
function _M0MPB3Map20add__entry__to__tailGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, entry) {
...
function _M0MPB3Map10set__entryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, entry, new_idx) {
...
function _M0MPB3Map10push__awayGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, entry) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      entry$2.psl = psl;
      _M0MPB3Map10set__entryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, entry$2, idx$2);
      return;
    } else {
      const _Some = _bind;
...
function _M0MPB3Map20rehash__place__entryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, outer) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      _M0MPB3Map20add__entry__to__tailGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, outer);
      return undefined;
    } else {
      const _Some = _bind;
      const _curr = _Some;
      if (psl > _curr.psl) {
        _M0MPB3Map10push__awayGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, _curr);
        outer.psl = psl;
        outer.prev = self.tail;
        _M0MPB3Map20add__entry__to__tailGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, outer);
        return undefined;
...
function _M0MPB3Map4growGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self) {
  ...
  while (true) {
    ...
    if (x === undefined) {
      ...
      _e.next = undefined;
      _M0MPB3Map20rehash__place__entryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, _e);
      _tmp = next_in_chain;
      continue;
    }
  }
}
function _M0MPB3Map15set__with__hashGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, key, value, hash) {
  let _tmp = 0;
  let _tmp$2 = hash & self.capacity_mask;
  while (true) {
    const psl = _tmp;
    ...
    if (_bind === undefined) {
      if (self.size >= self.grow_at) {
        _M0MPB3Map4growGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self);
        _tmp = 0;
      ...
      const entry = new _M0TPB5EntryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(_bind$2, _bind$3, psl, hash, key, value);
      _M0MPB3Map20add__entry__to__tailGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, entry);
      return undefined;
    } else {
      const _Some = _bind;
      const _curr_entry = _Some;
      ...
      if (psl > _curr_entry.psl) {
        ...
        _M0MPB3Map10push__awayGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, _curr_entry);
        const _bind$2 = self.tail;
        const _bind$3 = undefined;
        const entry = new _M0TPB5EntryGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(_bind$2, _bind$3, psl, hash, key, value);
        _M0MPB3Map20add__entry__to__tailGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, idx, entry);
...
function _M0MPB3Map3setGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, key, value) {
  _M0MPB3Map15set__with__hashGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, key, value, _M0IPC16uint646UInt64PB4Hash4hash(key));
}
function _M0MPB3Map3MapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(arr, capacity) {
  ...
  const m = _M0FPB8new__mapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(capacity$2);
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPB3Map3setGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(m, e._0, e._1);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MPB3Map3getGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self, key) {
...
function _M0MPC15array5Array3setGmE(self, index, value) {
  const len = self.length;
...
function _M0MPC15array5Array4makeGmE(len, elem) {
...
function _M0MP49LING7167111moon_2degui3src4math4Rect9translate(self, offset) {
  return new _M0TP49LING7167111moon_2degui3src4math4Rect(self.x + offset.x, self.y + offset.y, self.w, self.h);
}
...
function _M0MP49LING7167111moon_2degui3src4core13WindowManager9window__z(self, id) {
  ...
  while (true) {
    ...
    if (i < self.focus.length) {
      const _p = _M0MPC15array5Array2atGmE(self.focus, i);
      if (BigInt.asUintN(64, _p.val) === BigInt.asUintN(64, id.val)) {
        rank = i;
      }
      _tmp = i + 1 | 0;
...
function _M0MP49LING7167111moon_2degui3src4core12LayoutEngine14current__scope(self) {
  ...
  if (_p.length === 0) {
    ...
    return _M0MPC15array5Array2atGmE(self.layout_stack, self.layout_stack.length - 1 | 0);
  }
}
...
function _M0MP49LING7167111moon_2degui3src4core12LayerManager13current__clip(self) {
  ...
  if (_p.length === 0) {
    ...
    return _M0MPC15array5Array2atGmE(self.clip_stack, self.clip_stack.length - 1 | 0);
  }
}
...
function _M0MP49LING7167111moon_2degui3src4core7IdStack13current__seed(self) {
  ...
  if (_p.length === 0) {
    ...
    return _M0MPC15array5Array2atGmE(self.stack, self.stack.length - 1 | 0);
  }
}
...
function _M0MP49LING7167111moon_2degui3src4core7Painter20sub__painter_2einner(self, local_offset, sub_clip) {
  ...
  const _bind = self.clip_rect;
  let effective_clip;
  if (_bind === undefined) {
    if (sub_clip === undefined) {
      effective_clip = undefined;
    } else {
      const _Some = sub_clip;
      const _child = _Some;
      effective_clip = _child;
    }
  } else {
    const _Some = _bind;
    const _parent = _Some;
    if (sub_clip === undefined) {
      effective_clip = _parent;
    } else {
      const _Some$2 = sub_clip;
      const _child = _Some$2;
      effective_clip = _M0MP49LING7167111moon_2degui3src4math4Rect9intersect(_parent, _child);
    }
  }
  return _M0MP49LING7167111moon_2degui3src4core7Painter11new_2einner(self.draw_list, effective_clip, combined_offset);
}
function _M0MP49LING7167111moon_2degui3src4core7Painter12sub__painter(self, local_offset, sub_clip$46$opt) {
  let sub_clip;
  if (sub_clip$46$opt.$tag === 1) {
    const _Some = sub_clip$46$opt;
    sub_clip = _Some._0;
  } else {
    sub_clip = undefined;
  }
...
function _M0MP49LING7167111moon_2degui3src4core7Painter9pop__clip(self) {
...
function _M0MP49LING7167111moon_2degui3src4core6Memory29get__int__or__default_2einner(self, id, default_, tag) {
  const _bind = _M0MPC17hashmap7HashMap3getGRP49LING7167111moon_2degui3src4core2IdiE(self.integers, _M0MP49LING7167111moon_2degui3src4core6Memory12resolve__key(id, tag));
  if (_bind === undefined) {
    return default_;
  } else {
    const _Some = _bind;
...
function _M0MP49LING7167111moon_2degui3src4core12LayerManager10push__clip(self, rect) {
  ...
  if (_p.length === 0) {
    ...
    const parent_clip = _M0MPC15array5Array2atGmE(self.clip_stack, self.clip_stack.length - 1 | 0);
...
function _M0MP49LING7167111moon_2degui3src4core8RawInput19from__mouse_2einner(mouse_pos, mouse_down, mouse_secondary_down, dt) {
  return new _M0TP49LING7167111moon_2degui3src4core8RawInput(mouse_pos, mouse_down, _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, dt, [], "", _M0MP49LING7167111moon_2degui3src4core9Modifiers4noneN6recordS1515, mouse_secondary_down);
}
...
function _M0MP49LING7167111moon_2degui3src4core12FocusManager23process__tab__traversal(self, shift) {
  ...
  while (true) {
    const i = _tmp;
    if (i < count) {
      const _p$2 = _M0MPC15array5Array2atGmE(self.focusable_ids, i);
  ...
  return _M0MP49LING7167111moon_2degui3src4core12FocusManager14request__focus(self, _M0MPC15array5Array2atGmE(self.focusable_ids, next_idx));
}
...
function _M0FP49LING7167111moon_2degui3src9composite18tree__view_2einner(ctx, id_salt, nodes, selected_id, expanded_ids, indent_step, item_height, size) {
  ...
  if (is_focused && node_count > 0) {
    ...
    while (true) {
      const i = _tmp;
      if (i < node_count) {
        if (_M0IPC16option6OptionPB2Eq5equalGsE(_M0MPC15array5Array2atGmE(flat_nodes, i).node.id, cur_selected)) {
          sel_idx = i;
          break;
        }
        _tmp = i + 1 | 0;
    ...
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 8)) {
      if (sel_idx > 0) {
        cur_selected = _M0MPC15array5Array2atGmE(flat_nodes, sel_idx - 1 | 0).node.id;
        clicked_id = cur_selected;
      } else {
        if (sel_idx === -1) {
          cur_selected = _M0MPC15array5Array2atGmE(flat_nodes, 0).node.id;
          clicked_id = cur_selected;
        }
      }
    }
    ...
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 7) && sel_idx >= 0) {
      const flat = _M0MPC15array5Array2atGmE(flat_nodes, sel_idx);
      ...
      if (flat.has_children && flat.is_expanded) {
        ...
        while (true) {
          ...
          if (i < next_expanded.length) {
            if (_M0MPC15array5Array2atGmE(next_expanded, i) === flat.node.id) {
              idx_to_remove = i;
              break;
            }
            _tmp$2 = i + 1 | 0;
  ...
  while (true) {
    const i = _tmp;
    if (i < node_count) {
      const flat = _M0MPC15array5Array2atGmE(flat_nodes, i);
          ...
          if (flat.is_expanded) {
            ...
            while (true) {
              ...
              if (j < next_expanded.length) {
                if (_M0MPC15array5Array2atGmE(next_expanded, j) === node.id) {
                  found = j;
                  break;
                }
                _tmp$2 = j + 1 | 0;
...
function _M0FP49LING7167111moon_2degui3src9composite13table_2einner(ctx, id_salt, size, columns, row_count, render_cell, row_height, header_height, selected_row, sort_column, sort_direction) {
  ...
  const is_focused = _M0MP49LING7167111moon_2degui3src4core9UIContext10has__focus(ctx, _table_id);
  ...
  while (true) {
    const c = _tmp;
    if (c < total_cols) {
      const col = _M0MPC15array5Array2atGmE(columns, c);
  ...
  if (is_focused && row_count > 0) {
    let cur = _M0MP49LING7167111moon_2degui3src4core6Memory29get__int__or__default_2einner(ctx.memory, _table_id, 0, "kb_row");
    if (cur < 0) {
      cur = 0;
    }
    if (cur >= row_count) {
    ...
    _M0MP49LING7167111moon_2degui3src4core9UIContext19set__scroll__offset(ctx, body_container_id, scroll_y);
    _M0MP49LING7167111moon_2degui3src4core6Memory16set__int_2einner(ctx.memory, _table_id, cur, "kb_row", 0);
    kb_row = cur;
...
function _M0FP49LING7167111moon_2degui3src9composite17sparkline_2einner(ctx, id_salt, values, size, color, fill, show_hover) {
  ...
  if (fill) {
    ...
    while (true) {
      const i = _tmp$3;
      if (i < (count - 1 | 0)) {
        const p1 = _M0MPC15array5Array2atGmE(points, i);
        const p2 = _M0MPC15array5Array2atGmE(points, i + 1 | 0);
  ...
  while (true) {
    const i = _tmp$3;
    if (i < (count - 1 | 0)) {
      _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _M0MPC15array5Array2atGmE(points, i), _M0MPC15array5Array2atGmE(points, i + 1 | 0), color, 1.8);
      _tmp$3 = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (show_hover && _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, _rect)) {
    ...
    const pt = _M0MPC15array5Array2atGmE(points, snapped_idx);
    ...
    if (i < len) {
      ...
      if (code === 32 || (code === 9 || code === 10)) {
        if (tokens.length > 0) {
          ...
          const last = _M0MPC15array5Array2atGmE(tokens, last_idx);
...
function _M0FP49LING7167111moon_2degui3src9composite12plot_2einner(ctx, id_salt, series, size, show_grid, show_crosshair, show_legend) {
  ...
  if (show_legend && series.length > 0) {
    ...
    while (true) {
      const i = _tmp$3;
      if (i >= 0) {
        const s = _M0MPC15array5Array2atGmE(series, i);
...
function _M0FP49LING7167111moon_2degui3src9composite18bar__chart_2einner(ctx, id_salt, labels, values, size, bar_color) {
  ...
  while (true) {
    ...
    if (i < count) {
      ...
      if (i < labels.length) {
        const lbl = _M0MPC15array5Array2atGmE(labels, i);
  ...
  switch (node.$tag) {
    ...
    case 0: {
      ...
      while (true) {
        const i = _tmp;
        if (i < _tabs.length) {
          const tab = _M0MPC15array5Array2atGmE(_tabs, i);
          const font_sz = ctx.style.font_small * scale;
          ...
          _L: {
            ...
            if (i !== valid_active) {
              tab_switched = { _0: _M0MPC15array5Array2atGmE(_tabs, valid_active).id, _1: tab.id };
              new_active_idx = i;
            }
          }
      ...
      if (_bind === undefined) {
        ...
        while (true) {
          ...
          if (_ < _bind$2) {
            ...
            const _p = t.id;
            if (!(_p === _cid)) {
              _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(remaining, t);
            }
            _tmp$2 = _ + 1 | 0;
            continue;
          } else {
      ...
      if (content_rect.w > 0 && content_rect.h > 0) {
        const content_painter = _M0MP49LING7167111moon_2degui3src4core7Painter12sub__painter(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _M0MP49LING7167111moon_2degui3src4math4Vec24zeroN6recordS89, _M0DTPC16option6OptionGORP49LING7167111moon_2degui3src4math4RectE4None__);
        ...
        const active_tab_id = _M0MPC15array5Array2atGmE(_tabs, valid_active).id;
    ...
    default: {
      ...
      _L: {
        if (_direction === 0) {
          ...
          let w1 = total_w * cur_ratio;
          if (w1 < min_pane_size) {
            w1 = min_pane_size;
          }
          if (total_w - w1 < min_pane_size) {
            w1 = total_w - min_pane_size;
          }
          const w2 = total_w - w1;
          ...
          let h1 = total_h * cur_ratio;
          if (h1 < min_pane_size) {
            h1 = min_pane_size;
          }
          if (total_h - h1 < min_pane_size) {
            h1 = total_h - min_pane_size;
          }
          const h2 = total_h - h1;
...
function _M0FP49LING7167111moon_2degui3src9composite28context__menu__items_2einner(ctx, id_salt, open, pos, items, menu_width, viewport_size) {
  ...
  if (actionable.length > 0) {
    ...
    const kb_item = _M0MPC15array5Array2atGmE(items, cur);
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 2)) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 2);
  ...
  while (true) {
    ...
    if (i < _bind$5) {
      ...
      if (item.is_separator) {
        ...
        const hovered = (_M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, row_rect) || (ctx.active_submenu_id === item.id || kb_selected)) && !item.disabled;
        if (hovered) {
...
function _M0FP49LING7167111moon_2degui3src9composite24command__palette_2einner(ctx, open, query, commands, selected_index) {
  ...
  if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 2)) {
    const sel = filtered_count > 0 && new_selected_index < filtered_count ? _M0MPC15array5Array2atGmE(filtered, new_selected_index).id : undefined;
  ...
  while (true) {
    ...
    if (idx < filtered_count) {
      const item = _M0MPC15array5Array2atGmE(filtered, idx);
      let _tmp$3;
      const _p$3 = item.category;
      if (!(_p$3 === "")) {
        const _p$4 = item.category;
...
function _M0FP49LING7167111moon_2degui3src9composite9hex__byte(val) {
  const hi = val >> 4 & 15;
  const lo = val & 15;
  const hi_s = _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(_M0FP49LING7167111moon_2degui3src9composite9hex__byteN11hex__digitsS294, hi, hi + 1 | 0));
  const lo_s = _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(_M0FP49LING7167111moon_2degui3src9composite9hex__byteN11hex__digitsS294, lo, lo + 1 | 0));
  return `${hi_s}${lo_s}`;
}
function _M0FP49LING7167111moon_2degui3src9composite21color__picker_2einner(ctx, id_salt, color, show_alpha) {
  ...
  while (true) {
    ...
    if (step < 24) {
      ...
      const slice_rect = _M0MP49LING7167111moon_2degui3src4math4Rect3new(sq_x + (step + 0) * hue_step_w, hue_y, hue_step_w + 0.5, hue_h);
  ...
  if (show_alpha) {
    ...
    while (true) {
      ...
      if (step < 16) {
        ...
        const slice_rect = _M0MP49LING7167111moon_2degui3src4math4Rect3new(sq_x + (step + 0) * alpha_step_w, alpha_y, alpha_step_w + 0.5, alpha_h);
...
function _M0FP49LING7167111moon_2degui3src9composite21line__col__to__cursor(lines, line, col) {
  ...
  while (true) {
    const i = _tmp;
    if (i < safe_line) {
      pos = (pos + _M0MPC15array5Array2atGmE(lines, i).length | 0) + 1 | 0;
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  const line_len = _M0MPC15array5Array2atGmE(lines, safe_line).length;
...
function _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einner(ctx, id_salt, text, size, show_line_numbers, read_only) {
  ...
  const line_str = target_line < lines.length ? _M0MPC15array5Array2atGmE(lines, target_line) : "";
  ...
  if (is_focused) {
    ...
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 11)) {
      ...
      if (ctrl_held) {
        ...
        cursor_pos = _M0FP49LING7167111moon_2degui3src9composite21line__col__to__cursor(lines, _cur_line, _M0MPC15array5Array2atGmE(lines, _cur_line).length);
      }
    }
    if (!read_only) {
      let has_sel;
  ...
  if (has_selection) {
    ...
    while (true) {
      const idx = _tmp;
      if (idx < lines.length) {
        const line_len = _M0MPC15array5Array2atGmE(lines, idx).length;
        ...
        if (o_start < o_end) {
          ...
          if (line_y + line_h >= _rect.y && line_y <= _rect.y + _rect.h) {
            const pre = _M0FP49LING7167111moon_2degui3src9composite13string__slice(_M0MPC15array5Array2atGmE(lines, idx), 0, o_start - line_start | 0);
            const sel = _M0FP49LING7167111moon_2degui3src9composite13string__slice(_M0MPC15array5Array2atGmE(lines, idx), o_start - line_start | 0, o_end - line_start | 0);
  ...
  while (true) {
    ...
    if (idx < lines.length) {
      _L$2: {
        const line_text = _M0MPC15array5Array2atGmE(lines, idx);
        const line_y = _rect.y + pad_top + (idx + 0) * line_h - scroll_y;
  ...
  if (is_focused && (_M0MP49LING7167111moon_2degui3src4core9UIContext18is__caret__visible(ctx) && _active_line < lines.length)) {
    const active_str = _M0MPC15array5Array2atGmE(lines, _active_line);
...
function _M0FP49LING7167111moon_2degui3src7widgets6window(ctx, title, pos, size, content, id_salt, constrain_to) {
  ...
  if (_M0MP49LING7167111moon_2degui3src4core9UIContext10has__focus(ctx, id)) {
    const kb_step = 8 * scale;
    let dx = 0;
    let dy = 0;
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 7)) {
      dx = kb_step;
    ...
    if (dx !== 0 || dy !== 0) {
      win_pos = _M0MP49LING7167111moon_2degui3src4math4Vec23add(win_pos, _M0MP49LING7167111moon_2degui3src4math4Vec23new(dx, dy));
      if (constrain_to === undefined) {
      } else {
        const _Some = constrain_to;
        const _bounds = _Some;
...
function _M0FP49LING7167111moon_2degui3src7widgets20toast__stack_2einner(ctx, toasts, anchor, viewport_size) {
  ...
  const _bind$5 = placed_rects.length;
  let _tmp$5 = 0;
  while (true) {
    const _ = _tmp$5;
    if (_ < _bind$5) {
  ...
  while (true) {
    ...
    if (i < next_active.length) {
      const rect = _M0MPC15array5Array2atGmE(placed_rects, i);
      ...
      if (_M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, close_btn_rect)) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext17set__cursor__icon(ctx, "pointer");
        if (ctx.input.mouse_pressed) {
          dismissed_id = _M0MPC15array5Array2atGmE(next_active, i).id;
          break;
        }
      }
      if (_M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, rect)) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext26set__wants__capture__mouse(ctx, true);
      }
      _tmp$6 = i + 1 | 0;
      continue;
  ...
  const final_active = [];
  const _bind$6 = next_active.length;
  let _tmp$7 = 0;
  while (true) {
    const _ = _tmp$7;
    if (_ < _bind$6) {
  ...
  while (true) {
    ...
    if (i < final_active.length) {
      const toast = _M0MPC15array5Array2atGmE(final_active, i);
      const rect = _M0MPC15array5Array2atGmE(placed_rects, i);
      const scale = ctx.style.scale;
      ...
      const close_hover = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, _M0MP49LING7167111moon_2degui3src4math4Rect3new(rect.x + 280 - 24, rect.y + 6, 18, 18));
...
function _M0FP49LING7167111moon_2degui3src7widgets25split__horizontal_2einner(ctx, id_salt, split_ratio, size, left, right, min_ratio, max_ratio, min_px) {
  ...
  const hovered = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, hit_rect);
  _M0MP49LING7167111moon_2degui3src4core9UIContext19register__focusable(ctx, bar_id);
  const is_focused = _M0MP49LING7167111moon_2degui3src4core9UIContext10has__focus(ctx, bar_id);
  if (hovered) {
    _M0MP49LING7167111moon_2degui3src4core9UIContext17set__cursor__icon(ctx, "col-resize");
  }
  if (hovered && ctx.input.mouse_pressed) {
  ...
  if (is_focused) {
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 7)) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 7);
      effective_ratio = effective_ratio + 0.02 > max_ratio ? max_ratio : effective_ratio + 0.02;
    }
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 6)) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 6);
      effective_ratio = effective_ratio - 0.02 < min_ratio ? min_ratio : effective_ratio - 0.02;
    }
  }
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter11add__circle(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _M0MP49LING7167111moon_2degui3src4math4Vec23new(divider_x, mid_y + 6), 1.5, dot_col);
  if (is_focused) {
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _M0MP49LING7167111moon_2degui3src4math4Rect6expand(hit_rect, 1), _M0MP49LING7167111moon_2degui3src5color5Color13border__focus(), 1, ctx.style.radius_sm);
  }
...
function _M0FP49LING7167111moon_2degui3src7widgets26segmented__control_2einner(ctx, id_salt, options, selected_index, height, width) {
  ...
  while (true) {
    ...
    if (i < count) {
      ...
      const is_hovered = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, opt_rect);
      if (is_hovered) {
        _M0MP49LING7167111moon_2degui3src4core9UIContext17set__cursor__icon(ctx, "pointer");
        if (i !== current_sel) {
      ...
      const text_sz = _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(ctx, _M0MPC15array5Array2atGmE(options, i), font_sz);
      const text_pos = _M0MP49LING7167111moon_2degui3src4math4Vec23new(opt_x + (item_w - text_sz.x) * 0.5, pill_y + (pill_h - text_sz.y) * 0.5);
      _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), text_pos, _M0MPC15array5Array2atGmE(options, i), font_sz, text_col, "", 500);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP49LING7167111moon_2degui3src7widgets12scroll__area(ctx, id_salt, size, content) {
  ...
  const _bind = _M0MP49LING7167111moon_2degui3src4core9UIContext15allocate__space(ctx, size);
  const _container_rect = _bind._1;
  _M0MP49LING7167111moon_2degui3src4core9UIContext19register__focusable(ctx, container_id);
  ...
  if (_M0MP49LING7167111moon_2degui3src4core9UIContext10has__focus(ctx, container_id) && real_max_scroll > 0) {
    const kb_step = 36 * ctx.style.scale;
    const page = size.y * 0.85;
    let delta = 0;
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 9)) {
      delta = kb_step;
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 9);
    ...
    if (delta !== 0) {
      scroll_y = scroll_y + delta < 0 ? 0 : scroll_y + delta > real_max_scroll ? real_max_scroll : scroll_y + delta;
      _M0MP49LING7167111moon_2degui3src4core9UIContext19set__scroll__offset(ctx, container_id, scroll_y);
    }
  }
  _M0MP49LING7167111moon_2degui3src4core9UIContext11set__cursor(ctx, prev_cursor);
  _M0MP49LING7167111moon_2degui3src4core9UIContext21set__available__width(ctx, prev_avail_w);
  _M0MP49LING7167111moon_2degui3src4core9UIContext9pop__clip(ctx);
  if (_M0MP49LING7167111moon_2degui3src4core9UIContext10has__focus(ctx, container_id)) {
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _container_rect, _M0MP49LING7167111moon_2degui3src5color5Color13border__focus(), 1 * ctx.style.scale, ctx.style.radius_md);
  }
...
function _M0FP49LING7167111moon_2degui3src7widgets14dialog_2einner(ctx, id_salt, title, message, kind, confirm_label, cancel_label, width, viewport_size) {
  ...
  while (true) {
    ...
    if (idx < msg_lines.length) {
      ...
      if (line_y + msg_line_h <= btn_y - 6 * scale) {
        _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _M0MP49LING7167111moon_2degui3src4math4Vec23new(card_x + 60 * scale, line_y), _M0MPC15array5Array2atGmE(msg_lines, idx), msg_font_sz, _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary(), "", 500);
      }
      _tmp = idx + 1 | 0;
      continue;
    } else {
  ...
  const cancel_hovered = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, cancel_rect);
  const confirm_hovered = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, confirm_rect);
...
function _M0FP49LING7167111moon_2degui3src7widgets10combo__box(ctx, id_salt, label, selected_index, options) {
  ...
  const selected_str = current_idx >= 0 && current_idx < options.length ? _M0MPC15array5Array2atGmE(options, current_idx) : "";
  ...
  if (is_open) {
    ...
    while (true) {
      ...
      if (i < options.length) {
        ...
        _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _M0MP49LING7167111moon_2degui3src4math4Vec23new(item_rect.x + 8, item_rect.y + (24 - item_font_sz) * 0.5), _M0MPC15array5Array2atGmE(options, i), item_font_sz, item_text_col, "", 500);
        if (i === current_idx) {
...
function _M0FP49LING7167111moon_2degui3src7widgets8tab__bar(ctx, _id_str, tabs, selected_idx) {
  ...
  while (true) {
    const i = _tmp$2;
    if (i < tabs.length) {
      const tab_text = _M0MPC15array5Array2atGmE(tabs, i);
...
function _M0IP49LING7167111moon_2degui3src7widgets6ButtonP49LING7167111moon_2degui3src4core6Widget2ui(self, ctx) {
  ...
  const has_shortcut = self.shortcut.length > 0;
  const kbd_font_size = ctx.style.font_small * scale;
  const kbd_w = has_shortcut ? _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(ctx, self.shortcut, kbd_font_size).x + 14 * scale : 0;
  const min_w = has_shortcut ? 88 * scale : 68 * scale;
  const pad_w = has_shortcut ? 36 * scale : (ctx.style.spacing_sm + ctx.style.radius_md) * 2 * scale;
  const content_w = has_shortcut ? text_w + kbd_w + pad_w : text_w + pad_w;
  const auto_w = content_w > min_w ? content_w : min_w;
  const w = self.size.x > 0 ? self.size.x : auto_w;
  const h = self.size.y > 0 ? self.size.y : ctx.style.control_h_md * scale;
  const _bind = _M0MP49LING7167111moon_2degui3src4core9UIContext15allocate__space(ctx, _M0MP49LING7167111moon_2degui3src4math4Vec23new(w, h));
  const _id = _bind._0;
  const _rect = _bind._1;
  const _resp = _bind._2;
  ...
  const bg_color = self.primary ? (_resp.pressed ? _M0MP49LING7167111moon_2degui3src5color5Color15accent__pressed() : _resp.hovered ? _M0MP49LING7167111moon_2degui3src5color5Color13accent__hover() : _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary()) : _resp.pressed ? _M0MP49LING7167111moon_2degui3src5color5Color11bg__surface() : _resp.hovered ? _M0MP49LING7167111moon_2degui3src5color5Color10bg__subtle() : _M0MP49LING7167111moon_2degui3src5color5Color10bg__window();
  const border_color = _resp.has_focus ? _M0MP49LING7167111moon_2degui3src5color5Color13border__focus() : self.primary ? (_resp.pressed ? _M0MP49LING7167111moon_2degui3src5color5Color12accent__deep() : _M0MP49LING7167111moon_2degui3src5color5Color15accent__pressed()) : _resp.pressed ? _M0MP49LING7167111moon_2degui3src5color5Color14border__strong() : _resp.hovered ? _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary() : _M0MP49LING7167111moon_2degui3src5color5Color15border__default();
  const text_color = self.primary ? _M0MP49LING7167111moon_2degui3src5color5Color13text__inverse() : _resp.pressed ? _M0MP49LING7167111moon_2degui3src5color5Color12text__strong() : _resp.hovered ? _M0MP49LING7167111moon_2degui3src5color5Color13text__primary() : _M0MP49LING7167111moon_2degui3src5color5Color10text__body();
  const painter = _M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx);
  const radius = ctx.style.radius_md * scale;
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, draw_rect, bg_color, radius);
  const stroke_w = _resp.has_focus ? 1.5 * scale : 1;
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(painter, draw_rect, border_color, stroke_w, radius);
  if (has_shortcut) {
    const text_x = draw_rect.x + 12 * scale;
    const text_y = draw_rect.y + (draw_rect.h - font_size) * 0.5;
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(text_x, text_y), self.text, font_size, text_color, "", 500);
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, kbd_rect, kbd_bg, ctx.style.radius_sm * scale);
    const sc_w = _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(ctx, self.shortcut, kbd_font_size).x;
    const kbd_text_x = kbd_rect.x + (kbd_rect.w - sc_w) * 0.5;
    const kbd_text_y = kbd_rect.y + (kbd_rect.h - kbd_font_size) * 0.5;
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(kbd_text_x, kbd_text_y), self.shortcut, kbd_font_size, kbd_col, "", 500);
  } else {
...
function _M0FP49LING7167111moon_2degui3src7widgets18breadcrumb_2einner(ctx, id_salt, items, separator, max_visible) {
  ...
  if (should_fold) {
    ...
    while (true) {
      const i = _tmp;
      if (i < count) {
        _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(display_items, { _0: _M0MPC15array5Array2atGmE(items, i), _1: i });
        _tmp = i + 1 | 0;
        continue;
      } else {
        break;
  ...
  while (true) {
    const i = _tmp;
    if (i < num_display) {
      const item_sz = _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(ctx, _M0MPC15array5Array2atGmE(display_items, i)._0, font_sz);
  ...
  while (true) {
    const i = _tmp$2;
    if (i < num_display) {
      const _bind$2 = _M0MPC15array5Array2atGmE(display_items, i);
      const _orig_idx = _bind$2._1;
      if (i !== (num_display - 1 | 0) && _orig_idx >= 0) {
        _M0MPC15array5Array4pushGiE(selectable, i);
      }
      _tmp$2 = i + 1 | 0;
      continue;
    } else {
  ...
  let kb_pos = undefined;
  if (is_focused && selectable.length > 0) {
    let cur = _M0MP49LING7167111moon_2degui3src4core6Memory29get__int__or__default_2einner(ctx.memory, _id, 0, "kb");
    if (cur >= selectable.length) {
      cur = selectable.length - 1 | 0;
    }
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 7)) {
      cur = (cur + 1 | 0) < selectable.length ? cur + 1 | 0 : cur;
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 7);
    }
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 6)) {
      cur = (cur - 1 | 0) >= 0 ? cur - 1 | 0 : cur;
    ...
    _M0MP49LING7167111moon_2degui3src4core6Memory16set__int_2einner(ctx.memory, _id, cur, "kb", 0);
    kb_pos = _M0MPC15array5Array2atGiE(selectable, cur);
    if (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 2)) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 2);
      clicked_idx = _M0MPC15array5Array2atGmE(display_items, _M0MPC15array5Array2atGiE(selectable, cur))._1;
    }
  }
  ...
  while (true) {
    ...
    if (i < num_display) {
      ...
      const is_hovered = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, item_rect);
      const is_kb = _M0IPC16option6OptionPB2Eq5equalGiE(kb_pos, i);
      const painter = _M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx);
      ...
      const text_col = is_last ? _M0MP49LING7167111moon_2degui3src5color5Color12text__strong() : (is_hovered || is_kb) && _orig_idx >= 0 ? _M0MP49LING7167111moon_2degui3src5color5Color13text__primary() : _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary();
      const text_pos = _M0MP49LING7167111moon_2degui3src4math4Vec23new(current_x + 4, _rect.y + (h - font_sz) * 0.5);
      _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, text_pos, _label, font_sz, text_col, "", 500);
      ...
      if (!is_last) {
        ...
        _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, sep_pos, separator, font_sz, _M0MP49LING7167111moon_2degui3src5color5Color14text__disabled(), "", 500);
  ...
  if (is_focused) {
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(ctx), _rect, _M0MP49LING7167111moon_2degui3src5color5Color13border__focus(), 1 * scale, ctx.style.radius_sm * scale);
  }
...
function _M0FP49LING7167111moon_2degui3src7widgets13badge_2einner(ctx, text, kind, dot, pill) {
  ...
  if (dot) {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter11add__circle(p, dot_center, dot_r, _fg);
...
function _M0FP49LING7167111moon_2degui3src7widgets11tag_2einner(ctx, id_salt, text, kind, closable) {
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(p, _rect, is_focused ? _M0MP49LING7167111moon_2degui3src5color5Color13border__focus() : _border, is_focused ? 1.5 : 1, tag_radius);
  const text_y = _rect.y + (24 - font_sz) * 0.5;
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(p, _M0MP49LING7167111moon_2degui3src4math4Vec23new(_rect.x + 8, text_y), text, font_sz, _fg, "", 500);
  let closed = false;
  if (closable) {
    const close_box = _M0MP49LING7167111moon_2degui3src4math4Rect3new(_rect.x + w - 8 - 14, _rect.y + 5, 14, 14);
    const is_close_hovered = _M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, close_box);
    if (is_close_hovered) {
      _M0MP49LING7167111moon_2degui3src4core9UIContext17set__cursor__icon(ctx, "pointer");
    ...
    if (is_focused && (_M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 5) || _M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 2))) {
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 5);
      _M0MP49LING7167111moon_2degui3src4core10InputState12consume__key(ctx.input, 2);
      closed = true;
    }
    const x_center = _M0MP49LING7167111moon_2degui3src4math4Rect6center(close_box);
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(p, _M0MP49LING7167111moon_2degui3src4math4Vec23new(x_center.x - 3.5, x_center.y - 3.5), _M0MP49LING7167111moon_2degui3src4math4Vec23new(x_center.x + 3.5, x_center.y + 3.5), _fg, 1.2);
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(p, _M0MP49LING7167111moon_2degui3src4math4Vec23new(x_center.x - 3.5, x_center.y + 3.5), _M0MP49LING7167111moon_2degui3src4math4Vec23new(x_center.x + 3.5, x_center.y - 3.5), _fg, 1.2);
  }
...
function _M0FP49LING7167111moon_2degui8examples6canvas15mine__threshold(permille) {
  if (1000n === 0n) {
    $panic();
  }
  return BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, BigInt(permille)) * 4294967296n)) / BigInt.asUintN(64, 1000n));
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3new(seed, density_permille) {
  const density_permille$2 = density_permille < 1 ? 1 : density_permille > 999 ? 999 : density_permille;
  const _tmp = _M0FP49LING7167111moon_2degui8examples6canvas15mine__threshold(density_permille$2);
  const _bind = [];
  return new _M0TP49LING7167111moon_2degui8examples6canvas9MineWorld(seed, _tmp, _M0MPB3Map3MapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(new _M0TPB9ArrayViewGUmRP49LING7167111moon_2degui8examples6canvas9MineChunkEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3newN6constrS1261), [], 0, 0, 0, 0);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas11mine__mix64(z64) {
  let z = z64;
  z = BigInt.asUintN(64, z + 11400714819323198485n);
  z = BigInt.asUintN(64, BigInt.asUintN(64, z ^ BigInt.asUintN(64, BigInt.asUintN(64, z) >> BigInt(30 & 63))) * 13787848793156543929n);
  z = BigInt.asUintN(64, BigInt.asUintN(64, z ^ BigInt.asUintN(64, BigInt.asUintN(64, z) >> BigInt(27 & 63))) * 10723151780598845931n);
  return BigInt.asUintN(64, z ^ BigInt.asUintN(64, BigInt.asUintN(64, z) >> BigInt(31 & 63)));
}
function _M0FP49LING7167111moon_2degui8examples6canvas16mine__cell__hash(x, y, seed) {
  const hx = BigInt.asUintN(64, BigInt.asUintN(64, BigInt(x)) * 11400714819323198485n);
  const hy = BigInt.asUintN(64, BigInt.asUintN(64, BigInt(y)) * 14029467366897019727n);
  return _M0FP49LING7167111moon_2degui8examples6canvas11mine__mix64(BigInt.asUintN(64, _M0FP49LING7167111moon_2degui8examples6canvas11mine__mix64(BigInt.asUintN(64, hx ^ seed)) + hy));
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8is__mine(self, x, y) {
  return BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, _M0FP49LING7167111moon_2degui8examples6canvas16mine__cell__hash(x, y, self.seed)) >> BigInt(32 & 63))) < BigInt.asUintN(64, self.threshold);
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8adjacent(self, x, y) {
  let n = 0;
  let _tmp = -1;
  while (true) {
    const dy = _tmp;
    if (dy <= 1) {
      ...
      while (true) {
        const dx = _tmp$2;
        if (dx <= 1) {
          if ((dx !== 0 || dy !== 0) && _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8is__mine(self, x + dx | 0, y + dy | 0)) {
            n = n + 1 | 0;
          }
          _tmp$2 = dx + 1 | 0;
          continue;
...
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld5chunk(self, x, y) {
  ...
  if (_bind === undefined) {
    ...
    _M0MPB3Map3setGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(self.chunks, key, c);
    return c;
  } else {
    const _Some = _bind;
    return _Some;
...
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld11is__flagged(self, x, y) {
  const c = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld5chunk(self, x, y);
  const word = y & 63;
  const bit = x & 63;
  return BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, _M0MPC15array5Array2atGmE(c.flagged, word)) >> BigInt(bit & 63)) & 1n)) === BigInt.asUintN(64, 1n);
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(self, x, y) {
  const c = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld5chunk(self, x, y);
  const word = y & 63;
  const bit = x & 63;
  return BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, _M0MPC15array5Array2atGmE(c.revealed, word)) >> BigInt(bit & 63)) & 1n)) === BigInt.asUintN(64, 1n);
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, x, y) {
  if (!_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(self, x, y) && !_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld11is__flagged(self, x, y)) {
    _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(self.queue, { _0: x, _1: y });
    return;
  } else {
    return;
  }
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld13set__revealed(self, x, y) {
  const c = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld5chunk(self, x, y);
  const word = y & 63;
  const bit = x & 63;
  _M0MPC15array5Array3setGmE(c.revealed, word, BigInt.asUintN(64, _M0MPC15array5Array2atGmE(c.revealed, word) | BigInt.asUintN(64, 1n << BigInt(bit & 63))));
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld4pump(self, budget) {
  ...
  let processed = 0;
  while (true) {
    if (processed < budget && self.queue_head < self.queue.length) {
      const _bind$2 = _M0MPC15array5Array2atGmE(self.queue, self.queue_head);
      const _x = _bind$2._0;
      const _y = _bind$2._1;
      self.queue_head = self.queue_head + 1 | 0;
      if (self.queue_head > 8192 && (Math.imul(self.queue_head, 2) | 0) > self.queue.length) {
        const rest = [];
        let _tmp$2 = self.queue_head;
        while (true) {
          const i = _tmp$2;
          if (i < self.queue.length) {
            _M0MPC15array5Array4pushGRP49LING7167111moon_2degui3src4core5EventE(rest, _M0MPC15array5Array2atGmE(self.queue, i));
            _tmp$2 = i + 1 | 0;
            continue;
          } else {
            break;
      ...
      if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(self, _x, _y)) {
        continue;
      }
      _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld13set__revealed(self, _x, _y);
      self.revealed_count = self.revealed_count + 1 | 0;
      processed = processed + 1 | 0;
      if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8adjacent(self, _x, _y) === 0) {
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x - 1 | 0, _y - 1 | 0);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x, _y - 1 | 0);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x + 1 | 0, _y - 1 | 0);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x - 1 | 0, _y);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x + 1 | 0, _y);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x - 1 | 0, _y + 1 | 0);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x, _y + 1 | 0);
        _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, _x + 1 | 0, _y + 1 | 0);
...
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld6reveal(self, x, y) {
  const _bind = self.status;
  let _tmp;
  if (_bind === 0) {
    _tmp = true;
  ...
  if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld11is__flagged(self, x, y) || _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(self, x, y)) {
    return undefined;
  }
  if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8is__mine(self, x, y)) {
    self.status = 1;
    _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld13set__revealed(self, x, y);
    self.revealed_count = self.revealed_count + 1 | 0;
    return undefined;
  }
  _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld7enqueue(self, x, y);
}
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12set__flagged(self, x, y, value) {
  const c = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld5chunk(self, x, y);
  const word = y & 63;
  const bit = x & 63;
  if (value) {
    _M0MPC15array5Array3setGmE(c.flagged, word, BigInt.asUintN(64, _M0MPC15array5Array2atGmE(c.flagged, word) | BigInt.asUintN(64, 1n << BigInt(bit & 63))));
    return;
  } else {
    _M0MPC15array5Array3setGmE(c.flagged, word, BigInt.asUintN(64, _M0MPC15array5Array2atGmE(c.flagged, word) ^ BigInt.asUintN(64, 1n << BigInt(bit & 63))));
    return;
...
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12toggle__flag(self, x, y) {
  let _tmp;
  const _bind = self.status;
  let _tmp$2;
  if (_bind === 0) {
  ...
  if (!_tmp$2) {
    ...
    _tmp = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(self, x, y);
  }
  if (_tmp) {
    return undefined;
  }
  const was = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld11is__flagged(self, x, y);
  _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12set__flagged(self, x, y, !was);
  self.flagged_count = was ? self.flagged_count - 1 | 0 : self.flagged_count + 1 | 0;
}
function _M0FP49LING7167111moon_2degui8examples6canvas11mines__step(mouse_x, mouse_y, mouse_down, mouse_secondary_down, pan_dx, pan_dy, zoom_delta, action_switch, density_permille, vp_w, vp_h) {
  const raw = _M0MP49LING7167111moon_2degui3src4core8RawInput19from__mouse_2einner(_M0MP49LING7167111moon_2degui3src4math4Vec23new(mouse_x, mouse_y), mouse_down, mouse_secondary_down, 0.0166);
  _M0MP49LING7167111moon_2degui3src4core9UIContext12begin__frame(_M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx, raw);
  if (!_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.inited) {
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.inited = true;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x = -vp_w * 0.5 / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y = -vp_h * 0.5 / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell;
  }
  if (action_switch === 0) {
    const _p = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.world;
    const _p$2 = _p.seed;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.world = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3new(BigInt.asUintN(64, BigInt.asUintN(64, _p$2 * 6364136223846793005n) + 1442695040888963407n), _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.density);
  }
  if (action_switch === 1) {
  ...
  const density_in = density_permille < 1 ? 1 : density_permille > 999 ? 999 : density_permille;
  if (density_in !== _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.density) {
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.density = density_in;
    const _p = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.world;
    const _p$2 = _p.seed;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.world = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3new(BigInt.asUintN(64, BigInt.asUintN(64, _p$2 * 6364136223846793005n) + 1442695040888963407n), _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.density);
  }
  _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x - pan_dx;
  _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y - pan_dy;
  const pressed = mouse_down && !_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.prev_down;
  const released = !mouse_down && _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.prev_down;
  const secondary_pressed = mouse_secondary_down && !_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.prev_secondary;
  if (pressed) {
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.drag_move = false;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.gesture_flag = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.flag_mode || mouse_secondary_down;
  }
  if (mouse_down && (pan_dx !== 0 || pan_dy !== 0)) {
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.drag_move = true;
  }
  if (zoom_delta !== 0) {
    const old_cell = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell;
    const factor = zoom_delta > 0 ? 1.2 : 0.83333333333333337;
    const new_cell = old_cell * factor > 56 ? 56 : old_cell * factor < 8 ? 8 : old_cell * factor;
    const wx = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x + mouse_x / old_cell;
    const wy = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y + mouse_y / old_cell;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell = new_cell;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x = wx - mouse_x / new_cell;
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y = wy - mouse_y / new_cell;
  }
  const world = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.world;
  const _bind = world.status;
  let cursor;
  if (_bind === 0) {
    const tx = _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x + mouse_x / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell));
    const ty = _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y + mouse_y / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell));
    cursor = !_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(world, tx, ty) ? "pointer" : "default";
  } else {
    cursor = "default";
  }
  if (released && !_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.drag_move) {
    const wx = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x + mouse_x / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell;
    const wy = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y + mouse_y / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell;
    const cx = _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(wx));
    const cy = _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(wy));
    if (_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.gesture_flag || secondary_pressed) {
      _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12toggle__flag(world, cx, cy);
    } else {
      _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld6reveal(world, cx, cy);
    }
  }
  if (released) {
    _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.drag_move = false;
  }
  _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.prev_down = mouse_down;
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h), _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), 0);
  ...
  const row0 = _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y / cell));
  const cols = _M0MPC16double6Double7to__int(vp_w / cell) + 2 | 0;
  const rows = _M0MPC16double6Double7to__int(vp_h / cell) + 2 | 0;
  const num_font = cell >= 18 ? _M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx.style.font_normal : _M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx.style.font_small;
  let _tmp = row0;
  while (true) {
    const r = _tmp;
    if (r < (row0 + rows | 0)) {
      ...
      while (true) {
        const c = _tmp$2;
        if (c < (col0 + cols | 0)) {
          const sx = (c + 0) * cell - _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_x;
          const sy = (r + 0) * cell - _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cam_y;
          const tile = _M0MP49LING7167111moon_2degui3src4math4Rect3new(sx, sy, cell - 1, cell - 1);
          if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(world, c, r)) {
            _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, tile, _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), 0);
            _L: {
              _L$2: {
                const _bind$2 = world.status;
                if (_bind$2 === 1) {
                  if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8is__mine(world, c, r)) {
                    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, tile, _M0MP49LING7167111moon_2degui3src5color5Color6danger(), 0);
                    _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.3, sy + cell * 0.3), _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.7, sy + cell * 0.7), _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), 1.5);
                    _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.7, sy + cell * 0.3), _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.3, sy + cell * 0.7), _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), 1.5);
                  } else {
                    break _L$2;
                  }
                } else {
              ...
              const adj = _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld8adjacent(world, c, r);
              if (adj > 0 && lod_min) {
                const ty = sy + (cell - num_font) * 0.5;
                const tx = sx + (cell - _M0MP49LING7167111moon_2degui3src4core9UIContext13measure__text(_M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx, _M0MPC13int3Int18to__string_2einner(adj, 10), num_font).x) * 0.5;
                _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(tx, ty), _M0MPC13int3Int18to__string_2einner(adj, 10), num_font, _M0FP49LING7167111moon_2degui8examples6canvas20mines__number__color(adj), "monospace", 500);
              }
            }
          } else {
            if (lod_min) {
              const is_hover = _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(mouse_x / cell)) === c && _M0MPC16double6Double7to__int(_M0MPC16double6Double5floor(mouse_y / cell)) === r;
              _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, tile, is_hover ? _M0MP49LING7167111moon_2degui3src5color5Color9bg__hover() : _M0MP49LING7167111moon_2degui3src5color5Color10bg__subtle(), 0);
              if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld11is__flagged(world, c, r)) {
                const pole_x = sx + cell * 0.62;
                _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(pole_x, sy + cell * 0.18), _M0MP49LING7167111moon_2degui3src4math4Vec23new(pole_x, sy + cell * 0.78), _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary(), 1.2);
                _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.28, sy + cell * 0.2), _M0MP49LING7167111moon_2degui3src4math4Vec23new(pole_x, sy + cell * 0.4), _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), 2.4);
                _M0MP49LING7167111moon_2degui3src4core7Painter9add__line(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.28, sy + cell * 0.2), _M0MP49LING7167111moon_2degui3src4math4Vec23new(sx + cell * 0.28, sy + cell * 0.55), _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), 2.4);
              }
            }
          }
          _tmp$2 = c + 1 | 0;
  ...
  const _bind$2 = world.status;
  if (_bind$2 === 1) {
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, vp_h - 64, vp_w, 40), _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), _M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx.style.radius_md);
    _M0MP49LING7167111moon_2degui3src4core7Painter17add__text_2einner(painter, _M0MP49LING7167111moon_2degui3src4math4Vec23new(16, vp_h - 64 + 13), "踩雷！点顶栏「新雷区」重开 — 已翻开区域保留", _M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx.style.font_normal, _M0MP49LING7167111moon_2degui3src5color5Color6danger(), "", 500);
  }
  const _tmp$2 = _M0MP49LING7167111moon_2degui3src4core9UIContext10end__frame(_M0FP49LING7167111moon_2degui8examples6canvas10mines__ctx);
  const _tmp$3 = world.revealed_count;
  const _tmp$4 = world.flagged_count;
  const _tmp$5 = _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.density;
  const _bind$3 = world.status;
  let _tmp$6;
  if (_bind$3 === 1) {
    _tmp$6 = true;
  } else {
  ...
  return new _M0TP49LING7167111moon_2degui8examples6canvas10MinesFrame(_tmp$2, _tmp$3, _tmp$4, _tmp$5, _tmp$6, world.queue_head < world.queue.length, _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.flag_mode, cursor);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas9host__key(name) {
  switch (name) {
    case "Tab": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1262;
    }
    case "Enter": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1263;
    }
    case "Escape": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1264;
    }
    case " ": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1265;
    }
    case "ArrowUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1266;
    }
    case "ArrowDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1267;
    }
    case "ArrowLeft": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1268;
    }
    case "ArrowRight": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1269;
    }
    case "PageUp": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1270;
    }
    case "PageDown": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1271;
    }
    case "Home": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1272;
    }
    case "End": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1273;
    }
    case "Backspace": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1274;
    }
    case "Delete": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1275;
    }
    default: {
      return undefined;
    }
...
function _M0FP49LING7167111moon_2degui8examples6canvas26draw__bar__chart__showcase(ui) {
  ...
  if (_hover_bar === undefined) {
    ...
    if (_idx >= 0 && _idx < labels.length) {
      _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Bar Hovered: ${_M0MPC15array5Array2atGmE(labels, _idx)} = ${_M0MPC13int3Int18to__string_2einner(_M0MPC16double6Double7to__int(_M0MPC15array5Array2atGdE(values, _idx)), 10)}`;
      return;
    } else {
      return;
    }
...
function _M0FP49LING7167111moon_2degui8examples6canvas26draw__breadcrumb__showcase(ui) {
  ...
  if (_c1 === undefined) {
    ...
    const _Some = _c1;
    const _idx = _Some;
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.breadcrumb_last_clicked = _M0MPC15array5Array2atGmE(path1, _idx);
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Navigated to: ${_M0MPC15array5Array2atGmE(path1, _idx)}`;
  }
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 14);
  ...
  if (_c2 === undefined) {
    ...
    const _Some = _c2;
    const _idx = _Some;
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.breadcrumb_last_clicked = _M0MPC15array5Array2atGmE(long_path, _idx);
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Navigated to: ${_M0MPC15array5Array2atGmE(long_path, _idx)}`;
  }
...
function _M0FP49LING7167111moon_2degui8examples6canvas29draw__color__button__showcase(ui) {
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext10horizontal(ui, (row) => {
    ...
    while (true) {
      const i = _tmp;
      if (i < palette.length) {
        const _bind = _M0FP49LING7167111moon_2degui3src7widgets13color__button(row, `pal_${_M0MPC13int3Int18to__string_2einner(i, 10)}`, _M0MPC15array5Array2atGmE(palette, i));
        const _clicked = _bind._0;
        if (_clicked) {
          _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.color_idx = i;
          _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Selected Color: ${_M0MPC15array5Array2atGmE(names, i)}`;
        }
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext9separator(ui);
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 8);
  const active_col = _M0MPC15array5Array2atGmE(palette, _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.color_idx);
  const active_name = _M0MPC15array5Array2atGmE(names, _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.color_idx);
...
function _M0FP49LING7167111moon_2degui8examples6canvas26draw__combo__box__showcase(ui) {
  ...
  if (_f !== _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.combo_format) {
    ...
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Format selected: ${_M0MPC15array5Array2atGmE(formats, _f)}`;
  }
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 12);
  ...
  if (_c !== _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.combo_color) {
    ...
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Color space: ${_M0MPC15array5Array2atGmE(spaces, _c)}`;
    return;
  } else {
    return;
  }
...
function _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcase(ui, vp_w, vp_h) {
  ...
  const items = [_M0MP49LING7167111moon_2degui3src9composite15ContextMenuItem3new("copy", "复制当前组件代码", _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1276, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src9composite15ContextMenuItemEE4None__), _M0MP49LING7167111moon_2degui3src9composite15ContextMenuItem3new("paste", "粘贴图元属性", _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1277, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src9composite15ContextMenuItemEE4None__), _M0MP49LING7167111moon_2degui3src9composite15ContextMenuItem9separator(), _M0MP49LING7167111moon_2degui3src9composite15ContextMenuItem3new("inspect", "审查图元层级", _M0FP49LING7167111moon_2degui8examples6canvas29draw__context__menu__showcaseN6constrS1278, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src9composite15ContextMenuItemEE4None__), _M0MP49LING7167111moon_2degui3src9composite15ContextMenuItem3new("delete", "重置控件状态", undefined, -1, _M0DTPC16option6OptionGRPB5ArrayGRP49LING7167111moon_2degui3src9composite15ContextMenuItemEE4None__)];
...
function _M0FP49LING7167111moon_2degui8examples6canvas26draw__dock__area__showcase(ui, _cur_w, _cur_h) {
  _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(ui, "多视窗磁吸与分栏排版系统 (DockArea Workbench)", _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary());
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 6);
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext10horizontal(ui, (row) => {
    ...
    _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(row, 10);
    _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(row, "拖拽中缝发丝线可实时缩放分栏比例；点击标签可切换激活面板；点击 × 可关闭面板", _M0MP49LING7167111moon_2degui3src5color5Color11text__muted());
  });
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 10);
  ...
  const d_resp = _M0FP49LING7167111moon_2degui3src9composite10dock__area(ui, "gal_dock", dock_size, _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.dock_tree, (pane_ui, tab_id, rect) => {
    ...
    switch (tab_id) {
      case "explorer": {
        _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(pane_ui, "项目资源", _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary());
        _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(pane_ui, 4);
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "📁 src/core/");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "  📄 context.mbt");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "  📄 dock.mbt");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "📁 assets/");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "  🖼️ logo.png");
        return;
      }
      case "outline": {
        _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(pane_ui, "符号大纲", _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary());
        _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(pane_ui, 4);
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "⚡ pub enum DockSplitDirection");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "⚡ pub struct DockTab");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "⚡ pub enum DockNode");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "⚡ pub struct DockTree");
        return;
      }
      case "canvas": {
      ...
      case "shader": {
        _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(pane_ui, "WGSL 着色器", _M0MP49LING7167111moon_2degui3src5color5Color12text__strong());
        _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(pane_ui, 4);
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "@vertex fn vs_main() -> VertexOutput");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "@fragment fn fs_main() -> @location(0) vec4f");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "return vec4f(0.145, 0.388, 0.921, 1.0);");
        return;
      }
      case "console": {
        _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(pane_ui, "系统运行日志", _M0MP49LING7167111moon_2degui3src5color5Color11text__muted());
        _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(pane_ui, 4);
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "[00:01:23] [INFO] DockArea frame initialized.");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "[00:01:24] [INFO] Scissor clip applied to 3 panes.");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "[00:01:25] [OK] Layout split ratio stable at 60 FPS.");
        return;
      }
      case "terminal": {
        _M0MP49LING7167111moon_2degui3src4core9UIContext14label__colored(pane_ui, "zsh - moonbit", _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary());
        _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(pane_ui, 4);
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "$ moon test --target wasm-gc");
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, "Total tests: 195, passed: 195, failed: 0.");
        return;
      }
      default: {
        _M0MP49LING7167111moon_2degui3src4core9UIContext5label(pane_ui, `Panel: ${tab_id}`);
        return;
      }
    }
  });
  if (d_resp.ratio_changed) {
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = "Dock Splitter Dragged";
  }
  const _bind = d_resp.active_tab_changed;
  if (_bind === undefined) {
  } else {
    const _Some = _bind;
    const _x = _Some;
    const _old_id = _x._0;
    const _new_id = _x._1;
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Tab Switched: ${_old_id} -> ${_new_id}`;
  }
  const _bind$2 = d_resp.tab_closed;
  if (_bind$2 === undefined) {
    return;
  } else {
    const _Some = _bind$2;
    const _cid = _Some;
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Tab Closed: ${_cid}`;
    return;
  }
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas34draw__segmented__control__showcase(ui) {
  ...
  if (_sel !== _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.segmented_sel) {
    ...
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Segment Selected: ${_M0MPC15array5Array2atGmE(views, _sel)}`;
    return;
  } else {
    return;
  }
...
function _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcase(ui) {
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 14);
  _M0MP49LING7167111moon_2degui3src4core9UIContext10horizontal(ui, (row) => {
    _M0FP49LING7167111moon_2degui3src7widgets7spinner(row, _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1279, undefined, _M0DTPC16option6OptionGdE4None__);
    _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(row, 16);
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 16);
  _M0FP49LING7167111moon_2degui3src7widgets20spinner__with__label(ui, "正在同步远程 MoonBit 模块索引...", _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1280, undefined, _M0DTPC16option6OptionGdE4None__);
}
function _M0FP49LING7167111moon_2degui8examples6canvas24draw__splitter__showcase(ui) {
  ...
  const new_ratio = _M0FP49LING7167111moon_2degui3src7widgets25split__horizontal_2einner(ui, "gal_split_h", _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.splitter_ratio, split_size, (pane_ui, rect) => {
    ...
    _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(_M0MP49LING7167111moon_2degui3src4core9UIContext7painter(pane_ui), rect, _M0MP49LING7167111moon_2degui3src5color5Color11bg__surface(), 4);
    _M0MP49LING7167111moon_2degui3src4core9UIContext11set__cursor(pane_ui, _M0MP49LING7167111moon_2degui3src4math4Vec23new(rect.x + 12, rect.y + 12));
...
function _M0FP49LING7167111moon_2degui8examples6canvas24draw__tab__bar__showcase(ui) {
  ...
  if (_cur !== _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.tab_selected) {
    ...
    _M0FP49LING7167111moon_2degui8examples6canvas14gallery__state.status_text = `Tab switched: ${_M0MPC15array5Array2atGmE(tabs, _cur)}`;
  }
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 14);
  _M0MP49LING7167111moon_2degui3src4core9UIContext9separator(ui);
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 10);
...
function _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcase(ui, vp_w, vp_h) {
  ...
  }, _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1281, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h));
}
function _M0FP49LING7167111moon_2degui8examples6canvas24draw__component__preview(ui, comp_id, cur_w, cur_h) {
  switch (comp_id) {
    ...
    case "dock_area": {
      _M0FP49LING7167111moon_2degui8examples6canvas26draw__dock__area__showcase(ui, cur_w, cur_h);
      return;
    }
    case "table": {
...
function _M0FP49LING7167111moon_2degui8examples6canvas21gallery__step_2einner(comp_id, mouse_x, mouse_y, mouse_down, scroll_dy, vp_w, vp_h, text_input, keys_pressed, keys_released, mod_flags, mouse_secondary_down) {
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, cur_w, cur_h), _M0MP49LING7167111moon_2degui3src5color5Color10bg__subtle(), 0);
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(pad_x, 26, card_w, card_h), _M0MP49LING7167111moon_2degui3src5color5Color6shadow(), 8);
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, card_rect, _M0MP49LING7167111moon_2degui3src5color5Color10bg__window(), 8);
  _M0MP49LING7167111moon_2degui3src4core7Painter17add__rect__stroke(painter, card_rect, _M0MP49LING7167111moon_2degui3src5color5Color15border__default(), 1, 8);
...
(() => {
  ...
  _M0FP49LING7167111moon_2degui8examples6canvas11mines__step(0, 0, false, false, 0, 0, 0, -1, 156, 920, 540);
...
if (typeof window !== 'undefined') window.moon_mines_step = _M0FP49LING7167111moon_2degui8examples6canvas11mines__step;
if (typeof globalThis !== 'undefined') globalThis.moon_mines_step = _M0FP49LING7167111moon_2degui8examples6canvas11mines__step;
