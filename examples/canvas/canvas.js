...
function _M0TP49LING7167111moon_2degui8examples6canvas10MinesFrame(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
  this.draw_list = param0;
...
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1282 = 4;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1283 = 2;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1284 = 3;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1285 = 5;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1286 = 8;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1287 = 9;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1288 = 6;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1289 = 7;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1290 = 12;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1291 = 13;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1292 = 10;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1293 = 11;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1294 = 0;
const _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1295 = 1;
...
const _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3newN6constrS1281 = 64;
...
function _M0MP49LING7167111moon_2degui3src5color5Color11mines__grid() {
  return _M0MP49LING7167111moon_2degui3src5color5Color3hex(8162465);
}
function _M0MP49LING7167111moon_2degui3src5color5Color20mines__ground__hover() {
...
function _M0FP49LING7167111moon_2degui8examples6canvas18mines__zoom__about(st, anchor_x, anchor_y, factor) {
  const old_cell = st.cell;
  const scaled = old_cell * factor;
  const new_cell = scaled > 56 ? 56 : scaled < 12 ? 12 : scaled;
  if (new_cell === old_cell) {
    return undefined;
  }
  const wx = (anchor_x + st.cam_x) / old_cell;
  const wy = (anchor_y + st.cam_y) / old_cell;
  st.cell = new_cell;
  st.cam_x = wx * new_cell - anchor_x;
  st.cam_y = wy * new_cell - anchor_y;
}
function _M0FP49LING7167111moon_2degui8examples6canvas21mines__centre__camera(st, vp_w, vp_h) {
  const mid = (25600 + 0) * 0.5 * st.cell;
...
function _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3new(seed) {
  const _bind = [];
  return new _M0TP49LING7167111moon_2degui8examples6canvas9MineWorld(seed, _M0MPB3Map3MapGmRP49LING7167111moon_2degui8examples6canvas9MineChunkE(new _M0TPB9ArrayViewGUmRP49LING7167111moon_2degui8examples6canvas9MineChunkEE(_bind, 0, 0), _M0MP49LING7167111moon_2degui8examples6canvas9MineWorld3newN6constrS1281), [], 0, 0, 0, 0, undefined);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas17mines__draw__flag(painter, sx, sy, cell) {
  ...
  const left = sx + cell * 0.28;
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(left, sy + cell * 0.15, mast_w, cell * 0.7), _M0MP49LING7167111moon_2degui3src5color5Color15text__secondary(), mast_w * 0.5);
  const steps = _M0MPC16double6Double7to__int(cell * 0.55);
  const steps$2 = steps < 6 ? 6 : steps > 26 ? 26 : steps;
  const height = cell * 0.42;
  const bar = height / (steps$2 + 0) + 0.6;
  let _tmp = 0;
  while (true) {
    const k = _tmp;
    if (k < steps$2) {
      const t = (k + 0) / (steps$2 + 0);
      const w = cell * (0.46 - 0.4 * t);
      if (w > 0.4) {
        _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(left + mast_w, sy + cell * 0.15 + height * t, w, bar), _M0MP49LING7167111moon_2degui3src5color5Color15accent__primary(), 0);
      }
      _tmp = k + 1 | 0;
      continue;
    } else {
...
function _M0FP49LING7167111moon_2degui8examples6canvas11mines__step(mouse_x, mouse_y, mouse_down, mouse_secondary_down, pan_dx, pan_dy, zoom_delta, action_switch, vp_w, vp_h) {
  ...
  if (!_M0FP49LING7167111moon_2degui8examples6canvas9mines__st.inited) {
    ...
    _M0FP49LING7167111moon_2degui8examples6canvas21mines__centre__camera(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st, vp_w, vp_h);
  }
  if (action_switch === 0) {
  ...
  if (action_switch === 4) {
    _M0FP49LING7167111moon_2degui8examples6canvas18mines__zoom__about(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st, vp_w * 0.5, vp_h * 0.5, 22 / _M0FP49LING7167111moon_2degui8examples6canvas9mines__st.cell);
  }
  if (action_switch === 5) {
    _M0FP49LING7167111moon_2degui8examples6canvas21mines__centre__camera(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st, vp_w, vp_h);
  }
  ...
  if (zoom_delta !== 0) {
    ...
    _M0FP49LING7167111moon_2degui8examples6canvas18mines__zoom__about(_M0FP49LING7167111moon_2degui8examples6canvas9mines__st, mouse_x, mouse_y, factor);
  }
  ...
  _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h), _M0MP49LING7167111moon_2degui3src5color5Color11mines__grid(), 0);
      ...
      while (true) {
        ...
        if (c < (col0 + cols | 0)) {
          ...
          if (_M0MP49LING7167111moon_2degui8examples6canvas9MineWorld12is__revealed(world, c, r)) {
            ...
            _M0MP49LING7167111moon_2degui3src4core7Painter9add__rect(painter, tile, is_hover ? _M0MP49LING7167111moon_2degui3src5color5Color20mines__ground__hover() : _M0MP49LING7167111moon_2degui3src5color5Color13mines__ground(), 0);
...
function _M0FP49LING7167111moon_2degui8examples6canvas9host__key(name) {
  switch (name) {
    case "Tab": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1282;
    }
    case "Enter": {
      return _M0FP49LING7167111moon_2degui8examples6canvas9host__keyN6constrS1283;
    }
    case "Escape": {
...
function _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcase(ui) {
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 14);
  _M0MP49LING7167111moon_2degui3src4core9UIContext10horizontal(ui, (row) => {
    _M0FP49LING7167111moon_2degui3src7widgets7spinner(row, _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1299, undefined, _M0DTPC16option6OptionGdE4None__);
    _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(row, 16);
  ...
  _M0MP49LING7167111moon_2degui3src4core9UIContext6spacer(ui, 16);
  _M0FP49LING7167111moon_2degui3src7widgets20spinner__with__label(ui, "正在同步远程 MoonBit 模块索引...", _M0FP49LING7167111moon_2degui8examples6canvas23draw__spinner__showcaseN6constrS1300, undefined, _M0DTPC16option6OptionGdE4None__);
}
...
function _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcase(ui, vp_w, vp_h) {
  ...
  }, _M0FP49LING7167111moon_2degui8examples6canvas22draw__window__showcaseN6constrS1301, _M0MP49LING7167111moon_2degui3src4math4Rect3new(0, 0, vp_w, vp_h));
}
