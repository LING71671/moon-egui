...
const _M0MP49LING7167111moon_2degui3src9composite10TableStyle7defaultN6recordS2981 = new _M0TP49LING7167111moon_2degui3src9composite10TableStyle(32, 30, 6);
const _M0MP49LING7167111moon_2degui3src9composite9PlotStyle7defaultN6recordS2982 = new _M0TP49LING7167111moon_2degui3src9composite9PlotStyle(280, 150, 38, 14, 14, 24, 280, 150, 8);
const _M0MP49LING7167111moon_2degui3src9composite10FaderStyle7defaultN6recordS2984 = new _M0TP49LING7167111moon_2degui3src9composite10FaderStyle(44, 150, 6, 32, 20, 3);
const _M0MP49LING7167111moon_2degui3src9composite15CodeEditorStyle7defaultN6recordS2985 = new _M0TP49LING7167111moon_2degui3src9composite15CodeEditorStyle(12.5, 11, 20, 44, 6);
...
const _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einnerN6constrS2986 = 0;
...
function _M0IP49LING7167111moon_2degui3src9composite12TextSpanKindPB2Eq5equal(_x_1629, _x_1630) {
  switch (_x_1629.$tag) {
    case 0: {
      if (_x_1630.$tag === 0) {
        return true;
    ...
    default: {
      const _Link = _x_1629;
      const _$42$x0_1631 = _Link._0;
      if (_x_1630.$tag === 3) {
        const _Link$2 = _x_1630;
        const _$42$y0_1632 = _Link$2._0;
        return _$42$x0_1631 === _$42$y0_1632;
      } else {
        return false;
      }
    }
...
function _M0FP49LING7167111moon_2degui3src9composite13table_2einner(ctx, id_salt, size, columns, row_count, render_cell, row_height, header_height, selected_row, sort_column, sort_direction) {
  const scale = ctx.style.scale;
  const t_style = _M0MP49LING7167111moon_2degui3src9composite10TableStyle7defaultN6recordS2981;
...
function _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1168(_env, pt) {
  const min_x = _env._5;
  const min_y = _env._4;
...
function _M0FP49LING7167111moon_2degui3src9composite12plot_2einner(ctx, id_salt, series, size, show_grid, show_crosshair, show_legend) {
  const scale = ctx.style.scale;
  const p_style = _M0MP49LING7167111moon_2degui3src9composite9PlotStyle7defaultN6recordS2982;
  ...
  const _env = { _0: plot_rect, _1: plot_bottom, _2: span_y, _3: span_x, _4: min_y, _5: min_x };
  if (show_grid) {
    let _tmp$2 = 0;
    while (true) {
      const i = _tmp$2;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        switch (_bind$4) {
          case 0: {
            let prev_screen = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1168(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$3 = 1;
            while (true) {
              const i = _tmp$3;
              if (i < count) {
                const curr_screen = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1168(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          case 1: {
            ...
            while (true) {
              const i = _tmp$4;
              if (i < count) {
                const pt_screen = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1168(_env, _M0MPC15array5Array2atGsE(pts, i));
          ...
          default: {
            let prev_screen$2 = _M0FP49LING7167111moon_2degui3src9composite12plot_2einnerN21map__data__to__screenS1168(_env, _M0MPC15array5Array2atGsE(pts, 0));
            let _tmp$5 = 1;
            while (true) {
              const i = _tmp$5;
              if (i < count) {
...
function _M0MP49LING7167111moon_2degui3src9composite5Fader4show(self, ctx) {
  ...
  const font_nm = ctx.style.font_normal * scale;
  const font_sm = ctx.style.font_small * scale;
  const f_style = _M0MP49LING7167111moon_2degui3src9composite10FaderStyle7defaultN6recordS2984;
  ...
  while (true) {
    ...
    if (_ < _bind$4) {
      ...
      if (item.is_separator) {
        ...
        const hovered = (_M0MP49LING7167111moon_2degui3src4core9UIContext11is__hovered(ctx, row_rect) || ctx.active_submenu_id === item.id) && !item.disabled;
        if (hovered) {
...
function _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einner(ctx, id_salt, text, size, show_line_numbers, read_only) {
  ...
  const scale = ctx.style.scale;
  const ce_style = _M0MP49LING7167111moon_2degui3src9composite15CodeEditorStyle7defaultN6recordS2985;
  ...
  if (is_focused) {
    ...
    if (ctrl_held && _M0MP49LING7167111moon_2degui3src4core10InputState12key__pressed(ctx.input, 14)) {
      ...
      selection_anchor = _M0FP49LING7167111moon_2degui3src9composite20code__editor_2einnerN6constrS2986;
